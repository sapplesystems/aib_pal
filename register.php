...
<script type="text/javascript">
    ...
    function get_state() {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 275)');
                $('.loading-div').hide();
            }
        });
    }
...
//                    }
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 276)');
                }
            });
        }
    }
