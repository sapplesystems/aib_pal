  ...
  <div class="content2 contactInfo" style="min-height: 400px; padding:0 15px;">
    <div class="container" id="register_data">
      ...
      <div class="row marginTop20 padd5">
        <div class="col-md-3" >
          <label style="display:block;">User Name <span>*</span>:</label>
        </div>
        <div class="col-md-3" >
			<div class="row">
				<div class="col-md-11">
				...
				<div>
					<span class="field-tip" id="people_username" style="margin-left:0;top:0;">
						<img src="public/images/info.png" alt="">
						<span class="tip-content" id="people_username_msg"></span>
					</span>
				</div>
			</div>
        </div>
      ...
      <div class="row marginTop20 padd5">
        <div class="col-md-3" >
          <label style="display:block;">Email ID <span>*</span>:</label>
        </div>
        <div class="col-md-3">
			<div class="row">
				<div class="col-md-11">
                ...
                success: function (result) {
                    ...
                    if (result.status == 'success') {
                      ...
                      /*   setTimeout(function () {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 277)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 278)');
                }
            });
        }
    });
 	getAllHelpMessage('create_people_account');
</script>