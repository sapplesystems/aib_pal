...
<script type="text/javascript">
    $(document).ready(function(){
	 ...
	 var user_reporting = $('#user_reporting').DataTable({"pageLength": 100});
    function getUserReportingListing(){
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 279)');
            } 
        });
       }
	$(document).on('click', '.show_report_details', function(){
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 280)');
                } 
            });
	});
        ...
        $(document).on('click', '.delete_report_items', function(){
            ...
            if(confirm('Are you sure to delete ? This cannot be undone')){
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error','Something went wrong, Please try again. (Error Code: 281)');
                    } 
                });
            }
        });
        $(document).on('change', '.change_request_status', function(){
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 282)');
                } 
            });
        });
</script>