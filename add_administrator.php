                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result.status == 'success') {
                            ...
                            showPopupMessage('error', result.message + ' (Error Code: 1156)');
                        }
                        $('.admin-loading-image').hide();
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 101)');
                        $('.admin-loading-image').hide();
                    }
                });
            }
...
//        }
  ...
  function geck_user_exist(){
      ...
      $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 102)');
                $('.admin-loading-image').hide();
            }
        });
  }   
