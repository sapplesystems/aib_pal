...
<div class="content2">
    <div class="container-fluid">
        <div class="row-fluid">
            <div id="dynamic-tree-content" class="col-md-2 col-sm-3 leftModule d-desktop" ></div>
            <div class="col-md-8 col-sm-7 bgTexture default_breadcrumb" style="background:#f7f7f7;">
            <div class="btn-search" style="margin:0 30px 10px 20px;text-align:right;"><button class="btn btn-default abc">Search &#128269;</button></div>
            ...
            <div id="dynamic-tree-content-bottom-people" class="col-md-2 leftModule d-mobile def"></div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 254)');
                }
            });
...
$(document).on('click', '.share_front_record', function () {
    ...
    $(document).on('click', '#share_record_button', function () {
        if ($("#share_record_front").valid() && $('#share_record_front').val() == '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 255)');
                }
            });
        }
    ...
    function getSocietyHeaderImage(folder_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 256)');
            }
        });
    }
    ...
    $(document).on('click', '#copy_scrapbook_button', function(){
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 257)');
            }
        });
    });
