            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 441)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 442)');
                }
            });
        }
    });
...
//$('#details-back-button').click(function(){
    ...
    function ItemPageNumberSet(page, pagefolder) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 443)');
            }
        });
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 444)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 445)');
                }
            });
        }
    });
...
//            });
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 446)');
                }
            });
        }
...
//        var thumb_url = '<?php echo THUMB_URL; ?>';
    ...
    function getRecordTreedata(folder_id, itemId, share, flg, previousId, ref, detailPagecontent, pageNumber = '', pagefolder = '', start = '', total_item_page = '', action = '', imgFlg = '', searchString = '', recordIdsArr = '', scrapbook_item = '') {
        ...
        $.ajax({
            ...
            error: function () {
                $('.loading-div').hide();
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 447)');
            }
        });
    }
    ...
    function getRecordIds(id) {
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 448)');
            }
        });
    }
    function imageLoad() {
    ...
    function fullImageWithHighLight(pr_file_id, item_id, height, searchString) {
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 449)');
            }
        });
    }
</script>
