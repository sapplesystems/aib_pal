...
function ftree_replace_prop_batch($DBHandle,$ItemIDList,$PropertyName,$PropertyValue,$LongFlag = "N", $DeleteAltFlag = "Y")
{
	...
	if ($LongFlag == "Y")
	{
		...
		$Query = "INSERT INTO ftree_long_prop (item_id,property_name,property_value) VALUES $InsertString;";
	}
	else
	{
		$DelQuery = "DELETE FROM ftree_prop WHERE property_name='$PropertyName' AND ($ItemIDString);";
		$Query = "INSERT INTO ftree_prop (item_id,property_name,property_value) VALUES $InsertString;";
	}
