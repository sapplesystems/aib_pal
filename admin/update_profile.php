        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6 col-md-offset-3">
                <form class="marginBottom30 formStyle" class="form-group" action="" method="POST" id="profileForm" name="profileForm">
                    <div class="row">
                        <div class="col-md-5 "><strong>Login :
                                <span class="field-tip" id="login">
                                    <img src="public/images/info.png" alt="">
                                    <span class="tip-content" id="login_msg"></span>
                                </span>  
                            </strong>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-5 "><strong>Name :
                                <span class="field-tip" id="name">
                                    <img src="public/images/info.png" alt="">
                                    <span class="tip-content" id="name_msg"></span>
                                </span>  
                            </strong>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-5 "><strong>New Password :
                                <span class="field-tip" id="new_password">
                                    <img src="public/images/info.png" alt="">
                                    <span class="tip-content" id="new_password_msg"></span>
                                </span>  
                            </strong>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-5 "><strong>Confirm New Password  :
                                <span class="field-tip" id="confirm_new_pass">
                                    <img src="public/images/info.png" alt="">
                                    <span class="tip-content" id="confirm_new_pass_msg"></span>
                                </span>  
                            </strong>
			</div>
                    ...
                    <?php if ($_SESSION['aib']['user_data']['user_type'] != 'R') { ?>
                        ...
                        <div class="row">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="Y" name="term_service" id="term_service" <?php
    ...
    $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result.status == 'success') {
                            ...
                            showPopupMessage('error', result.message + ' (Error Code: 660)');
                        }
                        $('.admin-loading-image').hide();
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 661)');
                    }
                });
            }
        });
        ...
        function getPropData(user_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 662)');
                }
            });
