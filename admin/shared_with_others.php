...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <h4 class="list_title text-center"><span class="pull-left">Shared With Others</span> <span class="headingNameDesign"><?php echo $_SESSION['aib']['user_data']['item_title'];?></span></h4>
    </section>
...
<script type="text/javascript">
    ...
    function getItemDetailsById(folder_id) {
        ...
        $.ajax({
            ...
            type: "post",
            data: {mode: 'shared_record_list',share_type:'shared_from_user', folder_id: folder_id},
            ...
            error: function () {
                $('.admin-loading-image').hide();
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 637)');
            }
        });
    }
        ...
        if(ref_item_id){
            if(confirm('Are you sure you want to delete this? This cannot be undone')){
                ...
                $.ajax({
                    url: "services_admin_api.php",
                    type: "post",
                    data: {mode: 'delete_shared_record', ref_item_id: ref_item_id, delete_type: 'share_with_others',user_to_remove: removed_user, item_id: item_id},
                    success: function (result) {
                        ...
                        if(record.status == 'success'){
                            ...
                            showPopupMessage('error', record.message + ' (Error Code: 638)');
                            $('.admin-loading-image').hide();
                        } 
                    },
                    error: function () {
                        $('.admin-loading-image').hide();
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 639)');
                    }
                });
            }
        }
