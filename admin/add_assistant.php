            ...
            $.ajax({
                ...
                success: function (data){
                     ...
                     if(result.status == 'success'){
						...
						showPopupMessage('error', result.message + ' (Error Code: 340)');
                     }
                     $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 341)');
                }
            });
        }
    });
...
function geck_user_exist(){
      ...
      $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 342)');
                $('.admin-loading-image').hide();
            }
        });
  }   
