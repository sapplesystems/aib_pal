...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Trouble Ticket Requests</h1>
        <ol class="breadcrumb">
            <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Trouble Ticket Requests</li>
        </ol>
        <h4 class="list_title">Manage Trouble Ticket Requests </h4>
    </section>
                ...
                <table id="content_request_table" class="display table" width="100%" cellpadding="0" cellspacing="0">  
                    <thead>  
                        <tr>
                            ...
                            <th width="15%" class="text-center">Organization</th>
