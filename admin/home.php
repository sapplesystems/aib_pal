...
<div class="header_img bgBlue_header">
    ...
    if (isset($_REQUEST['show_text'])) {
        ...
        <div class="headerImage animate fadeInRightBig two"><h4 style=""><?php echo $title; ?></h4>
            <div class="descText"><?php echo $description; ?><ul><li><div class="readMoreLink"><a target="_blank" href="https://www.archiveinabox.com/default/">Investigate our Scanning Services</a></div></li><li><div class="readMoreLink"><a target="_blank" href="http://archiveinabox.com/interstitial-page2.html">Discover Hosting Options</a></div></li><li><div class="readMoreLink"><a href="why-us.html">Learn More</a></div></li></ul></div></div>
    <?php } ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 463)');
                }
            });
...
<?php } ?>
    ...
    $(document).on('click', '.setpagenumber', function () {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 464)');
            }
        });
    });
    ...
    function get_public_username(email) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 465)');
            }
        });
    }
    ...
    $(document).on('click', '#share_record_button', function () {
        if ($("#share_record_front").valid() && $('#share_record_front').val() == '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 466)');
                }
            });
        }
    ...
    $(document).on('click', '#share_item_button', function () {
        if ($("#share_items_front").valid() && $('#share_items_front').val() == '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 467)');
                }
            });
        }
    ...
    function getSocietyHeaderImage(folder_id) {
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 468)');
            }
        });
    }
    ...
    $(document).on('click', '#copy_scrapbook_button', function () {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 469)');
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 470)');
                }
                $('.loading-div').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 471)');
            }
        });
    }
