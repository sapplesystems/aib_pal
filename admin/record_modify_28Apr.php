...
//include("template/top_menu_admin_data.php");
	...
	$DisplayData["header_html"] = " "; // Set up pre-body scripts
...
//						array("field_click_callback" => "field_button_callback", "archive" => $LocalArchive,
//							"archive_group" => $LocalArchiveGroup));
			...
			switch($OpCode)
			{
				case "save_edit":
					...
					$OutBuffer[] = '<script>window.location.href="/2018/admin/manage_my_archive.php?folder_id='.$ParentFolderID.'";</script>';
						//header('location:http://develop.archiveinabox.com/2018/admin/manage_my_archive.php?folder-id='.$_REQUEST['parent']);
								//exit;
					break;
