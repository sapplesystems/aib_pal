...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">My Public Connections</li>
        </ol>
        <h4 class="list_title text-center"><span class="pull-left">My Public Connections</span> <span class="headingNameDesign"><?php echo $_SESSION['aib']['user_data']['item_title'];?></span></h4>
    </section>
...
<script type="text/javascript">
    ...
    function getShareLinkListing(){
        ...
        $.ajax({
            ...
            data: {mode:'get_user_share_link_listing'},
            ...
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 664)');
            } 
        });
    }
