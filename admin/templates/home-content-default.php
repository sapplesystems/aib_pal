...
<?php 
$connect_links = '';
if ($itemData['item_type'] != 'IT' && $_SESSION['aib']['user_data']['user_type'] == 'A' && $treeDataArray[1]['item_id'] != $_SESSION['aib']['user_data']['user_top_folder']) { 
                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>">
                                            ...
                                            <div class="mask">
                                                ...
                                                <?php } ?>
                                                <a class="custom-link details-page-url url-append animate-load-more" data-folder-id="<?php echo $itemDataArray['item_id']; ?>" item-id="<?php echo $itemDataArray['item_id']; ?>" child-count="<?php echo $itemDataArray['child_count']; ?>" item-type="<?php echo $itemDataArray['item_type']; ?>" item-parent="<?php echo $itemDataArray['_debug']['item_parent']; ?>" href="javascript:pageMoveToItemDetail(<?php echo $itemDataArray['item_id']; ?>,<?php echo $itemDataArray['child_count']; ?>,'<?php echo $itemDataArray['item_type'] ?>', <?php echo $itemDataArray['_debug']['item_parent'] ?>);">
...
var totalArchive = '<?php echo $totalArchive ?>';
var societyScrapbookListing = '<?php echo count($societyScrapbookListing) ?>';
