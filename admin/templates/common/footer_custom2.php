...
<div class="footer_bg">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="Logocenter"><img src="<?php echo IMAGE_PATH . 'logo-aib.png'; ?>" alt="AIB Logo" /></div>
                <p class="footer_copyright_archive">AIB™PAL Copyright &copy; <?php echo date('Y'); ?>. All Rights Reserved. "ArchiveInABox" and box device, and "AIB" are registered trademarks of SmallTownPapers, Inc.</p>
            </div>
            <div class="col-md-3">
                <!-- Fix start on 01-July-2025 -->
                <ul class="footerBottom-none">
                    <h3>Links</h3>
                    <li><a href="terms_condition.html"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Terms of Use</a></li>
                    <li><a href="privacy_cookies.html"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Privacy & cookies</a></li>
                    <li><a href="dmca.html"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> DMCA</a></li>
                    <li><a href="dmca_counter_notice.html"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> DMCA counter notice</a></li>
                </ul>
                <!-- Fix start on 01-July-2025 -->
            </div>
            <div class="col-md-3">
                <ul>
                    <h3>Links</h3>
                    <li><a href="javascript:void(0);" class="report-content"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Report Content</a></li>
                    <li><a href="javascript:void(0);" class="request-removal"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Request Content Removal</a></li>
                    <li><a href="javascript:void(0);" class="front-contact-us"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Contact Us</a></li>
                    <li><a href="javascript:void(0);" class="start-trouble-ticket"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Start Trouble Ticket</a></li>
                </ul>
            </div>
        </div>
    </div>
...
$jsArray = ['jquery-1.10.2.min.js', 'drag_scroll.js', 'bootstrap.js','jquery-ui.js', 'jquery-form-validate.min.js', 'ideal-image-slider.js', 'iis-bullet-nav.js', 'iis-captions.js', 'common.js', 'sappleslider.multi.js', 'snap.svg-min.js', 'tabulous.js', 'jquery.mCustomScrollbar.concat.min.js', 'jquery.dataTables.min.js', 'index.js', 'jquery.inputmask.bundle.js', 'tag-it.js', 'magicsuggest.js', 'selectize.js', 'slick.js'];//, 'scripts.js'
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 836)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 837)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 838)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 839)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 840)');
                }
                $('.loading-div').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 841)');
            }
        });
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 842)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 843)');
                }
            });
        }
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 844)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 845)');
                }
            });
        }
    });
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 846)');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 847)');
                }
            });
        }
        $(document).on('click', '#agree_term_condition', function () {
            ...
            $.ajax({
                ...
                eroor: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 848)');
                }
            });
        });
...
<?php } ?> 
<?php include_once COMMON_TEMPLATE_PATH . 'recaptcha.php'; ?>