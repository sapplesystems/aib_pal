...
if ($loginUserType == 'R') {
    $menuArray = [
        ...
        'My_Archive' => [
            ...
            'Register_Client' => 'register_society.php',
        ...
        // fix issue start for issue id 0002467 on 25-June-2025
//         'Public_User' => [
// //                'Add_Client_Administrator'=>'add_administrator.php',
//             'Manage_Public_User' => 'manage_public_user.php'
//         ],
        // fix issue end for issue id 0002467 on 25-June-2025
        'Revenue' => [
        ...
        // 'Security Questions' => [
		// 	//'Display_Ads' =>'display_ads.php',
		// 	'Add Questions' => 'add_security_questions.php',
		// 	'List Questions'=>'',
		// ],
        'Security_Questions' => 'add_security_questions.php',
        // fix issue start for issue id 0002468 on 25-June-2025
        // 'Manage_Content' => [
        ...
        //     'Claimed_Popup_Message' => 'claimed_popup_message.php',
        // ],
        // fix issue end for issue id 0002468 on 25-June-2025
        // fix issue start for issue id 0002469 on 25-June-2025
        ...
        // ],
        // 'Requested_Claims' => 'manage_claimed_user.php',
        // fix issue end for issue id 0002469 on 25-June-2025
        //Fix start for Issue ID 2140 on 23-Feb-2023
        // fix issue start for issue id 0002470 on 25-June-2025
        // 'Download_Report' => 'download_report.php',
        // fix issue end for issue id 0002470 on 25-June-2025
        //Fix end for Issue ID 2140 on 23-Feb-2023
        'Help_Message' => 'help_message.php',
        //Fix start for Issue ID 2180 on 30-March-2023
        'Upload User Guide' => 'upload_user_guide.php',
        //Fix end for Issue ID 2180 on 30-March-2023
		//Fix start for Issue ID 2147 on 28-Apr-2023
		'Homepage Settings' => 'homepage_settings.php',
    ...
    $menuArray = [
        'Dashboard' => [
            ...
            'Contact_Requests' => 'contact_request.php',
            //'Mail Opt Out' => 'opt_out_mail.php',
            'Manage Advertisement' => 'add_advertisement.php',
        ],
        'My_Archive' => [
            'Upload/Manage_Records' => 'manage_my_archive.php',
            'Create_Fields' => 'create_fields.php',
        ...
        //Fix start for Issue ID 2180 on 30-March-2023
        'Download User Guide' => 'download_user_guide.php',
        //Fix end for Issue ID 2180 on 30-March-2023
        'Sign_out' => 'admin.php?mode=logout'
    ];
...
if (($loginUserType == 'A' && $_SESSION['aib']['user_data']['user_prop']['type'] == 'primary') || $loginUserType == 'R') {
