            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">
					<div class="aib_logo_header">
						<a href="index.html"><img src="<?php echo IMAGE_PATH . 'logo-aib.png'; ?>" alt="Logo AIB" /></a>
					</div>
				</div>
