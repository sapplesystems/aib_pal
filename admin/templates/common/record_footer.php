               ...
               success: function (response) {
                  ...
                  $('.admin-loading-image').hide();
                   if(result.status == 'success'){
                       ...
                       showPopupMessage('error', result.message + ' (Error Code: 879)');
                   }
               },
               error: function () {
                   showPopupMessage('error','Something went wrong, Please try again. (Error Code: 880)');
               }
            });	
        }
    });
              ...
              success: function (response) {
                 ...
                 $('.admin-loading-image').hide();
                  if(result.status == 'success'){
                      ...
                      showPopupMessage('error', result.message + ' (Error Code: 881)');
                  }
              },
              error: function () {
                  showPopupMessage('error','Something went wrong, Please try again. (Error Code: 882)');
              }
            });	
        }
   });
                ...
                success: function (response) {
                   ...
                   $('.admin-loading-image').hide();
                    if(result.status == 'success'){
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 883)');
                    }
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 884)');
                }
            });	 
    }); 
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(result.status == 'success'){
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 885)');
                }
            },
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 886)');
            }
        });	
    }
});
