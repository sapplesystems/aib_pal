...
<div class="footer_bg">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class=""><img src="<?php echo IMAGE_PATH . 'logo-aib.png'; ?>" alt="AIB Logo" /></div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(result.status == 'success'){
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 859)');
                    }
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 860)');
                }
            }); 
	 });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(result.status == 'success'){
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 861)');
                    }
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 862)');
                }
            });	
		}
	 }); 
	 	...
	 	$.ajax({
                ...
                success: function (data){
                     ...
                     if(result.status == 'success'){ 
						...
						showPopupMessage('error', 'error','Something went wrong, Please try again. (Error Code: 863)');
                     }
                     $('.loading-div').hide();
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 864)');
                }
            });
}
       ...
       success: function (response) {
          ...
          $('.admin-loading-image').hide();
           if(result.status == 'success'){
               ...
               showPopupMessage('error', result.message + ' (Error Code: 865)');
           }
       },
       error: function () {
           showPopupMessage('error','Something went wrong, Please try again. (Error Code: 866)');
       }
   });	
       }
});
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(result.status == 'success'){
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 867)');
                }
            },
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 868)');
            }
        });
    }
});
 ...
 function service_term_condition_popup(){
	 $('.admin-loading-image').show();
	 	$.ajax({
		     ...
		     showPopupMessage('error', 'error','Something went wrong, Please try again. (Error Code: 869)');
                     }
                     $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 870)');
                }
            });
}
$(document).on('click','#agree_term_condition',function(){
  ...
  $.ajax({
      ...
      eroor:function(){
           showPopupMessage('error','Something went wrong, Please try again. (Error Code: 871)');
      }
  });
});
