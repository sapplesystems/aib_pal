                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>">
                                            ...
                                            <div class="mask">
                                                ...
                                                <?php } ?>
                                                <a class="custom-link details-page-url url-append" item-id="<?php echo $itemDataArray['item_id']; ?>" child-count="<?php echo $itemDataArray['child_count']; ?>" item-type="<?php echo $itemDataArray['item_type']; ?>" item-parent="<?php echo $itemDataArray['_debug']['item_parent']; ?>" href="javascript:pageMoveToItemDetail(<?php echo $itemDataArray['item_id']; ?>,<?php echo $itemDataArray['child_count']; ?>,'<?php echo $itemDataArray['item_type'] ?>', <?php echo $itemDataArray['_debug']['item_parent'] ?>);">
