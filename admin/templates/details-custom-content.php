                ...
                if ($(this).css("display") == "block") {
                    ...
                    var height = $(window).height();
                        $.ajax({
                            ...
                            error: function () {
                                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 707)');
                            }
                        });
    ...
    function getPrimaryImageData(pr_file_id, item_type, data_url, searchString= '', item_id = '') {
        ...
        if(pr_file_id !=''){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 708)');
                }
            }); 
        }else{
    ...
    function getItemCustomFields(item_id,ref_id) {
	    ...
	    $('.loading-div').show();
		    ...
		    $('.loading-div').hide();
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 709)');
                }
            });
        }
    }
    ...
    function getItemDetails(item_id) {
        if (item_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 710)');
                }
            });
        }
    }
    ...
    function getItemArchiveProperty(record_id) {
        if (record_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 711)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 712)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 713)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 714)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 715)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 716)');
                        setTimeout(function(){
                            $('.loginPopup').trigger('click');
                        },1000);
                    }else{
                        showPopupMessage('error', result.message + ' (Error Code: 717)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 718)');
                }
            });
        }
    });
    ...
    function listCommentThreads(parent_folder_id,action) {
        ...
        if (parent_folder_id) { 
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 719)');
                }
            });
        }
    }
    ...
    function deleteCommentFromThread(obj_id){
        if (obj_id) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 720)');
                }
            });
        }
    }
    function addCommentToThread(obj) {
        ...
        if (parent_thread) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 721)');
                }
            });
        }
    }
        ...
        $("#txtUserComments").keyup(function(e){
            ...
            if (e.keyCode == 13 && jQuery.trim(this.value)!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 722)');
                    }
                });
            }
        });
        ...
        $("#post-your-comments").on("click",function(){
            if (jQuery.trim($("#txtUserComments").val())!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 723)');
                    }
                });
            }
        });
...
$(document).on('click', '#load_comments_details_page', function(){
    ...
    function getRelatedItems(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 724)');
                }
            });
        }
    } 
	...
	function getPublicConnections(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 725)');
                }
            });
        }
    }
    function get_public_username(email){
         ...
         $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 726)');
            }
        });
    }
...
$('#linkPubConBtn').click(function(){
	...
	$.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 727)');
            }
        });
 ...
 function getScrapbookRecordDetails(record_id){
          $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 728)');
            }
        });
	...
	$(document).on("click" ,".report-user",function(){
        ...
        $(document).on("click","#report_submit",function(){
                       ...
                       $.ajax({
                        ...
                        error: function () {
                            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 729)');
                        }
                });
        });        
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(record.status == 'success'){
                        ...
                        showPopupMessage(response.status, response.message + ' (Error Code: 730)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 731)');
                }
            });
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(record.status == 'success'){
                ...
                showPopupMessage(response.status, response.message + ' (Error Code: 732)');
            }
        },
        error: function () {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 733)');
        }
    });
});
...
function getSavedScrapbookTitle(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 734)');
            }
        });
    }
}
...
function getItemOcrData(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 735)');
            }
        });
    }
}
...
function getItemDescription(item_id) {
    if (item_id) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 736)');
            }
        });
    }
}
