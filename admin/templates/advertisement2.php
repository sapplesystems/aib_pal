<style>
    ...
    #advertisement2.ad_border{/*width: 300px;display: inline-block;overflow: hidden;position: absolute;bottom: 15px;right: 15px; padding-left:0px; padding-right:0px; height:250px;*/}
...
if ($response['status'] == 'OK') {
    ...
    if ($ad_record_count) {
        ?>
        <div class="ad_border" id="advertisement2">
            ...
            <?php } else { ?>
                ...
                <?php /*if ($ad_display_flip_time > 0) { ?>
                    <script type="text/javascript">
                        setTimeout(function () {
                            getAdvertisementFlip2(<?php echo json_encode($response); ?>, '<?php echo $_REQUEST['folder_id']; ?>',<?php echo $a++; ?>);
