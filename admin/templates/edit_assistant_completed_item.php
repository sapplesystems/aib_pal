        ...
        <div id="edit-item-section">
            <?php if ($item_type == 'RE') { ?>
                <div class="form-group">
                    ...
                    <div class="col-md-3 item-display"><?php echo $treeDataArray[count($treeDataArray) - 2]['item_title']; ?></div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Record : </label>
                    <div class="col-md-3 item-display"><?php echo $itemDetails['item_title']; ?></div>
                </div>
            <?php } if ($item_type == 'IT') { ?>
                <div class="form-group">
                    <label class="col-md-4 control-label">Sub Group : </label>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">Record : </label>
                    <div class="col-md-3 item-display"><?php echo $itemDetails['parent_details']['item_title']; ?></div>
                </div>
                <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-xs-4">
					<button type="button" class="btn btn-info borderRadiusNone" name="update_form_data" id="update_completed_form_data">Submit</button>
                    ...
                    <div class="inner">
                        <ul>
                            ...
                            foreach($itemDetails['files_records'] as $imageList){ ?>
                                <li onclick="checkGetEditData('<?php echo $imageList['item_parent']; ?>', '<?php echo $imageList['item_id']; ?>', '1');">
