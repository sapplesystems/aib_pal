    ...
    $(document).ready(function () {
        ...
        if(usertype == 'U'){
			$.ajax({
				...
				error: function () {
					showPopupMessage('error','Something went wrong, Please try again. (Error Code: 367)');
				}
			});
        ...
        function template_field_data(arch_id) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 368)');
                }
            });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result.status == 'success') {
                            ...
                            showPopupMessage('error', result.message + ' (Error Code: 369)');
                        }
                        $('.admin-loading-image').hide();
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 370)');
                    }
                });
            }
        });
