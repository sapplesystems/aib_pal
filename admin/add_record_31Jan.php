		...
		<td align='left' valign='top'>
			...
			switch($OpCode)
			{
				...
				case "edit":
					...
					$OutBuffer[] = aib_gen_form_header("pageform","/record_form_2018.php",false,"validate_form");
			...
			switch($OpCode)
			{
				...
				case "save":
					...
					$TargetSpec[] = array( "url" => "/record_form_2018.php", "title" => "Add Another Record","fields" => $TempFields);
					$OutBuffer[] = aib_chain_link_set($TargetSpec);
					break;
