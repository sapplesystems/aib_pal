        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6 col-md-offset-3">
                <form class="marginBottom30 formStyle" class="form-group" action="" method="POST" id="editArchiveGroupDetails" name="editArchiveGroupDetails" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 text-right"><strong>Description :
                    ...
                    <div class="row">
                        <div class="col-md-4 text-right"><strong>Show Contact Button :
                                <span class="field-tip" id="show_contact">
                                    <img src="public/images/info.png" alt="">
                                    <span class="tip-content" id="show_contact_msg"></span>
                                </span>
                            </strong>
			</div>
                        <div class="col-md-8 col-sm-6 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-4 text-right"><strong>Profile Image :
...
<script type="text/javascript">
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#archive_logo_image_pre').Jcrop({
                    ...
                    minSize: [1600, 400],//minSize: [crop_height, 3900],
                    maxSize: [1600, 400],//maxSize: [crop_height, 3900], 
                    aspectRatio: 3 / 1,
    ...
    $(document).on('click', '#editArchiveDetails', function (e) {
        ...
        if ($("#editArchiveGroupDetails").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 572)');
                }
            });
        }
    });
    ...
    function getItemPropDetails(archive_id) {
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 573)');
                }
            });
        }
    }
    $(document).on('click', '#close_crop_popup', function (e) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 574)');
            }
        });
    });
    function get_state() {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 575)');
                $('.loading-div').hide();
            }
        });
    }
