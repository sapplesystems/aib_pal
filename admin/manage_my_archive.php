...
<style type="text/css">
    ...
    #advertisement_popup .modal-lg{width: 95%;}
    .ad_action_icon{cursor: pointer;}
    .adtable th{text-align: center;}
    .ad_sorting_order{width: 40px;text-align: center;}
    .ad_inherited_chk{width: 30px;height: 30px;}
    .ad_title_td{width: 100px;}
    .ad_alt_title_td{width: 100px;}
    .ad_file_td{width: 100px;}
    .ad_url_td{width: 400px;}
    .ad_inherited_chk_td{width: 110px;}
    .ad_sorting_order_td{width: 110px;}
    .ad_action_td{width: 110px;}
</style>
<div class="content-wrapper">
    <section class="content-header">
        ...
        <h4 class="list_title text-center"><span class="pull-left">Manage Knowledge Base</span> <span class="headingNameDesign"></span> <?php if (isset($_SESSION['aib']['return_data']) && $_SESSION['aib']['return_data'] != '') { ?><span class="pull-right" id="back_to_advertisement"><a href="manage_advertisements.php?return=1&<?php echo $_SESSION['aib']['return_data']; ?>"><img title="Back to advertisements" src="<?php echo IMAGE_PATH . 'back.png'; ?>" alt="Back to advertisements" /></a></span><?php } ?></h4>
    </section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title"><span id="popup_heading">Create Knowledge Base</span> <button type="button" class="close" data-dismiss="modal">&times;</button></h4>
            </div>
            <div class="modal-body">
                <form id="create_new_items_form" name="create_new_items_form" method="post" class="form-horizontal">
                    ...
                    <div id="archive-group" class="archive-group">
                        ...
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Knowledge Base Title</label>
                            <div class="col-xs-7">
                        ...
                        <div class="col-xs-7">
                            <span class="custom-dropdown">
                                <select class="form-control" name="default_sorting_by" id="default_sorting_by">
									...
									<option value="ASCII">ASCII Value for Titile</option>
...
<div class="modal fade bs-example-modal-lg" id="advertisement_popup" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title">
                    <span id="popup_heading">Advertisement</span> 
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </h4>
                <span id="heading_listing_breadcrumb"></span>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="ad_item_id" id="ad_item_id" value="" />
                        <div class="add_new_ad">
                            <div class="row">
                                <div class="col-md-4">
                                    <label>
                                        Folder Advertising Settings: &nbsp;
                                        <span id="ad_display_sorting_order"></span>
                                        <a href="javascript:void(0);" id="change_ad_display_setting" style="color:#72afd2">Change</a>
                                    </label>
                                </div>
                                <div id="adsettings" style="display:none;">
                                    <div class="col-md-4" id="ad_display_setting_sorting_order">
                                        <label>
                                            Display Order : &nbsp;
                                            <input type="radio" name="sorting_order" class="sorting_order" id="sorting_order1" value="1" /> Static
                                            &nbsp;&nbsp;
                                            <input type="radio" name="sorting_order" class="sorting_order" id="sorting_order0" value="2" /> Random
                                        </label>
                                    </div>
                                    <div class="col-md-4" id="ad_display_setting_flip">
                                        <label>
                                            Flip : <!--&nbsp;
                                            <input type="radio" name="display_type" class="display_type" id="display_type_scroll" value="2" /> Scroll
                                            &nbsp;&nbsp;
                                                           -->
                                            <input type="checkbox" name="display_type" class="display_type" id="display_type_flip" value="1" /> Flip Speed
                                            <!--input type="text" id="display_flip_time" value="10" placeholder="Flip Time in Second(s)"/-->
                                            <select id="display_flip_time" class="hide">
                                                <option value="">Select</option>
                                                <option value="-1">On Page Reload</option>
                ...
                <div class="row" id="advertisement_tbody_master_row">
                    <div class="col-md-12 text-center marginBottom10">
                        <div class="tableStyle">
                            <table class="table adtable" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <thead>
                                    <tr>
                                        <th colspan="8">Advertising Portfolio</th>
                                    </tr>
                                    <tr>
                                        <th>Ad Title</th>
                                        <th>Ad Alt Title</th>
                                ...
                                <tbody id="advertisement_tbody_master"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <div class="row" id="advertisement_tbody_child_row">
                    <div class="col-md-12 text-center marginBottom10">
                        <div class="tableStyle">
                            <table class="table adtable" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <thead>
                                    <tr>
                                        <th colspan="7">Advertisements applied to this folder</th>
                                    </tr>
                                    <tr>
                                        <th>Ad Title</th>
                                        <th>Ad Alt Title</th>
                                ...
                                <tbody id="advertisement_tbody_child"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <div class="row" id="advertisement_tbody_from_parent_row">
                    <div class="col-md-12 text-center marginBottom10">
                        <div class="tableStyle">
                            <table class="table adtable" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <thead>
                                    <tr>
                                        <th colspan="7">Advertisements applied from parent folder(s)</th>
                                    </tr>
                                    <tr>
                                        <th>Ad Title</th>
                                        <th>Ad Alt Title</th>
                                ...
                                <tbody id="advertisement_tbody_from_parent"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
...
<div class="modal fade bs-example-modal-lg" id="google_ad_popup" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title"><span id="popup_heading">Google Ad</span> 
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="g_ad_item_id" id="g_ad_item_id" value="" />
                        <div class="add_new_ad">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="google_ad_frm" name="google_ad_frm" method="post" class="form-horizontal">
                                        <table class="table">
                                            <tbody>
                                             <tr>
                                                    <td colspan="5"><label><input type="checkbox" name="switch_off_all_adds" id="switch_off_all_adds" value="1" /> Switch off all adds</label></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td><label>Google Ad Position</label></td>
                                                    <td><label><input type="checkbox" name="top_left_position" id="top_left_position" value="top_ad" /> Top Left</label></td>
                                                    <td><label><input type="checkbox" name="top_right_position" id="top_right_position" value="top_ad" /> Top Right</label></td>
                                                    <td><label><input type="checkbox" name="bottom_left_position" id="bottom_left_position" value="bottom_left" /> Bottom Left</label></td>
                                                    <td><label><input type="checkbox" name="bottom_right_position" id="bottom_right_position" value="bottom_right" /> Bottom Right</label></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
                                                        <label>Google Ad Script</label>
                                                        <textarea class="form-control" name="google_ad_script" id="google_ad_script" rows="10"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" colspan="4">
                                                        <input class="btn btn-info" type="submit" name="google_ad_frm_sub" id="google_ad_frm_sub" value="Save">
...
<div class="modal fade bs-example-modal-lg" id="watermark_popup" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title"><span id="popup_heading">Add Watermark</span> 
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </h4>
            </div>
            <div class="modal-body">
                <form id="watermark_frm" name="watermark_frm" method="post" class="form-horizontal">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <label>Archive Watermark Text</label>
                                    <input class="form-control" type="text" name="archive_watermark_text" id="archive_watermark_text" value="" />
                                </td>
                            </tr>
							<!--/************* SS FIX START 0002309   21-Sep-2023 ************************/-->
							 ...
							 <tr>
                                <td>
									<div id="archive_download_watermark_div">
                                    <label>Archive Download Watermark Text</label>
                                    <input class="form-control" type="text" name="archive_download_watermark_text" id="archive_download_watermark_text" value="" />
										</div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3" style="text-align: right;">
                                    <label>&nbsp;</label>
                                    <input type="hidden" name="wm_item_id" id="wm_item_id" value="">
                                    <input class="btn btn-info" type="submit" name="watermark_frm_sub" id="watermark_frm_sub" value="Submit" />
                                    <input class="btn btn-default" data-dismiss="modal" type="button" value="Cancel" />
                                </td>
                            </tr>
                        </tbody>
...
<div class="modal fade bs-example-modal-lg" id="delete_records_popup1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title"><span id="popup1_heading">&nbsp;</span> 
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </h4>
            </div>
            <div class="modal-body text-center">
                <h4><strong style="font-weight: 600;"><span id="delete_records_popup1_heading"></span></strong></h4>
                <br/><br/>
                <input class="btn btn-info" id="delete_records_popup1_yes" type="button" value="Yes" />
                <input class="btn btn-danger" data-dismiss="modal" type="button" value="No" />
                <input type="hidden" id="deleteConfirmMsgSub" value="" />
                <input type="hidden" id="deleteConfirmItemType" value="" />
                <input type="hidden" id="delete_item_id" value="" />
                <input type="hidden" id="delete_parent_id" value="" />
            </div>
        </div>
    </div>
</div>

<div class="modal fade bs-example-modal-lg" id="delete_records_popup2" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header form_header">
                <h4 class="list_title"><span id="popup2_heading">&nbsp;</span> 
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </h4>
            </div>
            <div class="modal-body text-center">
                <h4><strong style="font-weight: 600;"><span id="delete_records_popup2_heading"></span></strong></h4>
                <br/><br/>
                <input class="btn btn-info" id="delete_records_popup2_confirm" type="button" value="Confirm" />
...
<script type="text/javascript">
    var aib_ad_storge_path = '<?php echo AIB_AD_STORAGE_PATH; ?>';
    var root_path = '<?php echo ROOT_PATH; ?>';
    var _archive_group_id = '<?php echo $archive_group_id; ?>';
...
<?php } ?>
                ...
                error: function () {
                    $('.admin-loading-image').hide();
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 522)');
                }
            });
        }
    }
    $(document).on("click", "#create_archive_group", function () {
        ...
        $('#popup_heading').text('Create Knowledge Base');
    ...
    $(document).on("click", "#create_sub_group", function () {
        ...
        $('#assign_assistant_to_sub_group').hide();
        $('#save_form_data').show();
		if($('#AIB_DOWNLOAD_ENABLE_RECORD_LEVEL').val()==1){
			$('#download_to_public_item  option[value=1]').attr('selected','selected');
		}
    });
    $(document).on("click", "#assignment", function () {
        ...
        if (sub_group_count > 0) {
            ...
            showPopupMessage('error', 'Select at least one sub-group. (Error Code: 556)');
            return false;
        }
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', 'Something went wrong! Please try again. (Error Code: 523)');
                        return false;
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 524)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (record.status == 'success') {
                    ...
                    showPopupMessage('error', record.message + ' (Error Code: 525)');
                }
            }
        });
    });
    ...
    $(document).on('click', '.edit_listing_item', function () {
        ...
        if (item_id != '' && item_type != '') {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 526)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'Something went wrong! Please try again. (Error Code: 527)');
                    return false;
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 528)');
            }
        });
    });
    $(document).on('click', '.delete_listing_item', function () {
        var deleteConfirmMsgSub = $(this).attr('data-field-delete-msg');
        var deleteConfirmItemType = $(this).attr('data-field-delete-msg-type');
        var item_id = $(this).attr('data-field-delete-id');
        var parent_id = $('#current-item-id').val();
        $('#popup1_heading').html('Delete'+deleteConfirmItemType);
        $('#delete_records_popup1_heading').html('Are you sure you want to delete the "'+deleteConfirmMsgSub+'"'+deleteConfirmItemType+'?');
        $('#deleteConfirmMsgSub').val(deleteConfirmMsgSub);
        $('#deleteConfirmItemType').val(deleteConfirmItemType);
        $('#delete_item_id').val(item_id);
        $('#delete_parent_id').val(parent_id);
        $('#delete_records_popup1').modal('show');
        return false;
        /*if(confirm('Are you sure you want to delete the "'+deleteConfirmMsgSub+'"'+deleteConfirmItemType+'?')) {
            if (confirm('Please confirm you want to delete the "'+deleteConfirmMsgSub+'"'+deleteConfirmItemType+". This cannot be undone.")) {
                var item_id = $(this).attr('data-field-delete-id');
    ...
    $(document).on('click','#delete_records_popup1_yes',function(){
        var deleteConfirmMsgSub = $('#deleteConfirmMsgSub').val();
        var deleteConfirmItemType = $('#deleteConfirmItemType').val();
        $('#popup2_heading').html('Delete'+deleteConfirmItemType);
        $('#delete_records_popup2_heading').html('Please confirm you want to delete the "'+deleteConfirmMsgSub+'"'+deleteConfirmItemType+". This cannot be undone.");
        $('#delete_records_popup1').modal('hide');
        $('#delete_records_popup2').modal('show');
        return false;
    });
    
    $(document).on('click','#delete_records_popup2_confirm',function(){
        var item_id = $('#delete_item_id').val();
        var parent_id = $('#delete_parent_id').val();
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'delete_item_by_id', item_id: item_id},
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'Something went wrong! Please try again. (Error Code: 529)');
                    return false;
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 530)');
            }
        });
        $('#delete_records_popup1').modal('hide');
        $('#delete_records_popup2').modal('hide');
        return false;
    });
$('#delete_records_popup2').on('hidden.bs.modal', function () {
    ...
    $(document).on("click", "#move", function () {
        ...
        if (move == true) {
            ...
            $.ajax({
                ...
                error: function () {
                    $('.admin-loading-image').hide();
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 531)');
                }
            });
        }
    });
...
//        });
    ...
    $(document).on("click", "#share_record_with_user", function () {
        ...
        if ($("#share_user_record").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 532)');
                }
            });
        }
    });
    ...
    function selectPublicUser(email) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 533)');
            }
        });
    }
    $(function () {
...
// save ebay link for records.
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (record.status == 'success') {
                        ...
                        showPopupMessage(record.status, record.message + ' (Error Code: 534)');
                        $('#ebay_link_model_id').modal('hide');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 535)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (record.status == 'success') {
                    ...
                    showPopupMessage(record.status, record.message + ' (Error Code: 536)');
                    $('#ebay_link_model_id').modal('hide');
                }
                $('.admin-loading-image').hide();
            },
    ...
    function check_ebay_link_save(record_id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if ($('#ebay_url').val() != '') {
                    $('#ebay_remove_link').css("display", "block");
                }
                $('.admin-loading-image').hide();
            },
            error: function () {
    ...
    $(document).on('click', '#move_selected_item', function () {
        ...
        if (item_count > 0 && selected_parent !== '') {
            ...
            showPopupMessage('error', "Item and parents both are required. (Error Code: 557)");
        }
    });
        ...
        if (item_id && item_id != '') {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (obj.status == 'OK') {
                        if(sorting_order == '1'){
                            $('#ad_display_sorting_order').html('Static');
                            $('#ad_display_setting_flip').css('display','none');
                        }else if(sorting_order == '2'){
                            $('#ad_display_sorting_order').html('Random');
                            $('#ad_display_setting_flip').css('display','');
                        }
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 537)');
                    $('.admin-loading-image').hide();
                }
            });
        }
    ...
    $(document).on('change', '.display_type', function () {
        $('#display_flip_time').addClass('hide');
        var item_id = $('#ad_item_id').val();
        var display_type = $(this).val();//document.getElementById('sorting_order').checked;
        if($(this).is(':checked') != true){
            display_type = -1;
        }
        if(display_type && display_type == '1'){
            $('#display_flip_time').removeClass('hide');
        }
        if (item_id && item_id != '') {
            $('.admin-loading-image').show();
            $.ajax({
                url: "services_admin_api.php",
                type: "post",
                data: {mode: 'set_ad_display_type', item_id: item_id, display_type: display_type},
                success: function (response) {
                    var obj = JSON.parse(response);
                    if (obj.status == 'OK') {
                        showPopupMessage('success', 'Display type changed successfully.');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 538)');
                    $('.admin-loading-image').hide();
                }
            });
        }
    ...
    $(document).on('change', '#display_flip_time', function () {
        var item_id = $('#ad_item_id').val();
        var flip_time = $(this).val();
        if (item_id && item_id != '') {
            $('.admin-loading-image').show();
            $.ajax({
                url: "services_admin_api.php",
                type: "post",
                data: {mode: 'set_ad_display_flip_time', item_id: item_id, flip_time: flip_time},
                success: function (response) {
                    var obj = JSON.parse(response);
                    if (obj.status == 'OK') {
                        showPopupMessage('success', 'Flip time saved successfully.');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 539)');
                    $('.admin-loading-image').hide();
                }
            });
        }
    ...
    //google_ad_frm_sub
    $(document).on('click', '#google_ad_frm_sub', function (e) {
        e.preventDefault();
        var item_id = $('#g_ad_item_id').val();
        var ad_script = $('#google_ad_script').val();
		 var switch_off_all_add_var = $('#switch_off_all_adds').is(':checked');
        var top_left_position = $('#top_left_position').is(':checked');
        var top_right_position = $('#top_right_position').is(':checked');
        var bottom_left_position = $('#bottom_left_position').is(':checked');
        var bottom_right_position = $('#bottom_right_position').is(':checked');
        var position1 = '';
        var position2 = '';
        var position3 = '';
        var position4 = '';
		var switch_off_all_adds = '0';
        if(switch_off_all_add_var == true){
            switch_off_all_adds = '1';
        }
		if(top_left_position == true){
            position1 = 'top_left_position';
        }
        if(top_right_position == true){
            position2 = 'top_right_position';
        }
        if(bottom_left_position == true){
            position3 = 'bottom_left_position';
        }
        if(bottom_right_position == true){
            position4 = 'bottom_right_position';
        }
        ...
        if (item_id && item_id != '') {
            ...
            $.ajax({
                url: "services_admin_api.php",
                type: "post",
                data: {mode: 'set_google_ad_script', item_id: item_id, ad_script: ad_script, position1: position1, position2: position2, position3: position3, position4: position4,switch_off_all_adds:switch_off_all_adds},
                success: function (response) {
                    var obj = JSON.parse(response);
                    if (obj.status == 'OK') {
                        showPopupMessage('success', 'Google Ad saved successfully.');
                        $('#google_ad_popup').modal('hide');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 540)');
                    $('.admin-loading-image').hide();
                }
            });
        }
    ...
    $(document).on('click','#change_ad_display_setting',function(){
        $('#adsettings').toggle();
        $('#ad_display_setting_sorting_order').css('display','');
    });
    
    /*$(document).on('click','#advertisement_tbody_master .ad_inherited_chk',function(){
        $('#advertisement_tbody_master .ad_inherited_chk').prop('checked',false);
        $(this).prop('checked',true);
    });*/
    
    function googleAd(item_id) {
        if (item_id) {
            $('#g_ad_item_id').val(item_id);
            $('#google_ad_popup').modal('show');
            if (item_id) {
                $('.admin-loading-image').show();
                $.ajax({
                    url: "services_admin_api.php",
                    type: "post",
                    data: {mode: 'get_google_ad_script', item_id: item_id},
                    success: function (response) {
                        var obj = JSON.parse(response);
                        if (obj.status == 'OK') {
                            ...
                            if (google_ad_script != '') {
                                ...
                                $('#switch_off_all_adds').prop('checked',false);
                                $('#top_left_position').prop('checked',false);
                                $('#top_right_position').prop('checked',false);
                                $('#bottom_left_position').prop('checked',false);
                                $('#bottom_right_position').prop('checked',false);
                                if(switch_off_all_adds != null && switch_off_all_adds ==1){
                                    $('#switch_off_all_adds').prop('checked',true);
                                } 
								if(top_left_position != null && top_left_position != ''){
                                    $('#top_left_position').prop('checked',true);
                                }
                                if(top_right_position != null && top_right_position != ''){
                                    $('#top_right_position').prop('checked',true);
                                }
                                if(bottom_left_position != null && bottom_left_position != ''){
                                    $('#bottom_left_position').prop('checked',true);
                                }
                                if(bottom_right_position != null && bottom_right_position != ''){
                                    $('#bottom_right_position').prop('checked',true);
                                }
                            }
                        }
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 541)');
                    }
                });
            }
        } else {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 542)');
        }
        $('.admin-loading-image').hide();
    }
    ...
    function advertisement(item_id) {
        if (item_id) {
            ...
            var heading_listing_row = $('#heading_listing_row').html();
            $('#heading_listing_breadcrumb').html(heading_listing_row);
            $('#heading_listing_breadcrumb ul li').removeClass('getItemDataByFolderId');
            $('#advertisement_popup').modal('show');
            //getAdvertisement(item_id);
            if(_archive_group_id){
                getAdvertisement(_archive_group_id, item_id);
            }
        } else {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 543)');
        }
    }
    
    function getAdvertisement(parent_id, item_id) {
        $('#adsettings,#ad_display_setting_sorting_order,#ad_display_setting_flip').css('display','none');
        $('#advertisement_tbody_master,#advertisement_tbody_child,#advertisement_tbody_from_parent').html('');
        $('#advertisement_tbody_master_row,#advertisement_tbody_child_row,#advertisement_tbody_from_parent_row').addClass('hide');
        if (parent_id && item_id) {
            $('.admin-loading-image').show();
            $.ajax({
                url: "services_admin_api.php",
                type: "post",
                data: {mode: 'get_ad_global_properties', item_id: item_id},
                success: function (response) {
                    var obj = JSON.parse(response);
                    if (obj.status == 'OK') {
                        var ad_sorting_order = obj.ad_sorting_order;
                        var ad_display_type = obj.ad_display_type;
                        var ad_display_flip_time = obj.ad_display_flip_time;
                        ...
                        if (ad_display_type == '1') {
                            $('#display_type_flip').prop('checked', true);
                            $('#display_flip_time').val(ad_display_flip_time);
                            $('#display_flip_time').removeClass('hide');
                            //$('#sorting_order').val('1');
                        } else {
                            $('#display_type_scroll').prop('checked', true);
                            //$('#sorting_order').val('0');
                        }
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 544)');
                    $('.admin-loading-image').hide();
                    resetAdvertisementForm();
                }
            });
            
            getAdvertisementListChild(item_id, parent_id);
        }
    }
    
    function getAdvertisementListChild(item_id, parent_id){
            ...
            success: function (response) {
                ...
                if (obj.status == 'OK' && obj.record_id != '') {
                    ...
                    for (var x = 0; x < record_length; x++) {
                        var rec_id = record[x].record_id;
                        var inherited = record[x].inherit_flag;
                        var ad_order = record[x].ad_sort_order;
                        var rec_ref = record[x].record_ref;
                        if(parent_id == item_id && rec_ref <= 0){
                            continue;
                        }
                        if(rec_ref > 0){
                            reference.push(rec_ref);
                        }
                        /*var ad_checked = '';
                        if(rec_id != ''){
                            ad_checked = 'checked';
                        ...
                        if (rec_ref > 0 && record[x].source_def.original_file != '') {
                            org_img = '<img style="width: 50px;height: 50px;" src="../get_ad_thumb.php?original_file=' + record[x].source_def.original_file + '" />';
                        }
                        var action = '';
                        //action = '<span class="manage-archive-group adv_action"><img title="Edit Ad" src="public/images/edit_icon.png" alt="Edit Ad" onclick="editAd(\'' + record[x].record_id + '\');"></span>';
                        //action += ' <span class="adv_action"><img title="Remove Ad" src="public/images/deactive.png" alt="Remove Ad" onclick="deleteAd(\'' + record[x].record_id + '\');"></span>';
                        //action += '<input type="checkbox" onclick />';
                        html += '<tr id="tr_' + record[x].record_id + '">';
                        html += '<td class="ad_title_td">' + record[x].ad_title + '</td>';
                        html += '<td class="ad_alt_title_td">' + record[x].ad_alt_title + '</td>';
                        html += '<td class="ad_file_td">' + org_img + '</td>';
                        html += '<td class="ad_url_td">' + record[x].ad_url + '</td>';
                        //html += '<td>' + record[x].inherit_flag + '</td>';
                        //html += '<td><input type="checkbox" id="set_ad_'+record[x].record_id+'" /></td>';
                        html += '<td class="ad_inherited_chk_td"><input type="checkbox" class="ad_inherited_chk" id="apply_child_'+record[x].record_id+'" '+ad_inherited+' /></td>';
                        //html += '<td>' + record[x].ad_sort_order + '</td>';
                        html += '<td class="ad_sorting_order_td"><input type="text" class="ad_sorting_order" id="ad_order_'+record[x].record_id+'" value="'+ad_order+'" /></td>';
                        //html += '<td>' + action + '</td>';
                        html += '<td class="ad_action_td"><img class="ad_action_icon" src="public/images/active.png" title="Update Ad" alt="Update Ad" onclick="setAdd('+record[x].record_id+','+item_id+','+record[x].record_id+','+parent_id+');" /> ';
                        
                        //if(record[x].item_id == item_id){
                            html += ' <img class="ad_action_icon" src="public/images/deactive.png" title="Remove Ad" alt="Remove Ad" onclick="deleteAd('+record[x].record_id+','+item_id+','+parent_id+');" />';
                        //}
                        html += '</td>';
                        html += '</tr>';
                    }
                    if(html != ''){
                        $('#advertisement_tbody_child').html(html);
                        $('#advertisement_tbody_child_row').removeClass('hide');
                    }
                }
                $('.admin-loading-image').hide();
                if(parent_id == item_id){
                    getAdvertisementListMaster(item_id, parent_id, reference);
                }else{
                    getAdvertisementListFromParent(item_id, parent_id, reference);
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 545)');
                $('.admin-loading-image').hide();
            }
        });
    }
    
    function getAdvertisementListFromParent(item_id, parent_id, reference){
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'get_visible_advertisement_list', item_id: item_id},
            success: function (response) {
                var obj = JSON.parse(response);
                if (obj.status == 'OK' && obj.record_id != '') {
                    var record = obj.info.records;
                    ...
                    for (var x = 0; x < record_length; x++) {
                        var rec_ref = record[x].record_ref;
                        if(reference.includes(record[x].source_def.record_id) == true){
                            continue;
                        }
                        if(parent_id == item_id && rec_ref <= 0){
                            continue;
                        ...
                        //html += '<td>' + record[x].inherit_flag + '</td>';
                        //html += '<td><input type="checkbox" id="set_ad_'+record[x].record_id+'" /></td>';
                        html += '<td class="ad_inherited_chk_td"><input type="checkbox" class="ad_inherited_chk" checked disabled /></td>';
                        //html += '<td>' + record[x].ad_sort_order + '</td>';
                        html += '<td class="ad_sorting_order_td"><input type="text" class="ad_sorting_order" value="'+record[x].ad_sort_order+'" readonly /></td>';
                        //html += '<td>' + action + '</td>';
                        html += '<td class="ad_action_td"></td>';
                        html += '</tr>';
                    }
                    if(html != ''){
                        $('#advertisement_tbody_from_parent').html(html);
                        $('#advertisement_tbody_from_parent_row').removeClass('hide');
                    }
                }
                $('.admin-loading-image').hide();
                getAdvertisementListMaster(item_id, parent_id, reference);
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 546)');
                $('.admin-loading-image').hide();
            }
        });
    }
    
    function getAdvertisementListMaster(item_id, parent_id, reference){
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'get_advertisement_list', item_id: parent_id},
            success: function (response) {
                var obj = JSON.parse(response);
                if (obj.status == 'OK' && obj.record_id != '') {
                    var record = obj.info.records;
                    ...
                    for (var x = 0; x < record_length; x++) {
                        var rec_ref = record[x].record_ref;
                        if(reference.includes(record[x].record_id) == true || rec_ref > 0){
                            continue;
                        }
                        var org_img = '';
                        if (record[x].original_file != '') {
                        ...
                        //html += '<td>' + record[x].inherit_flag + '</td>';
                        //html += '<td><input type="checkbox" id="set_ad_'+record[x].record_id+'" /></td>';
                        html += '<td class="ad_inherited_chk_td"><input type="checkbox" class="ad_inherited_chk" id="apply_child_'+record[x].record_id+'" /></td>';
                        //html += '<td>' + record[x].ad_sort_order + '</td>';
                        html += '<td class="ad_sorting_order_td"><input type="text" class="ad_sorting_order" id="ad_order_'+record[x].record_id+'" /></td>';
                        //html += '<td>' + action + '</td>';
                        html += '<td class="ad_action_td"><img class="ad_action_icon" src="public/images/active.png" title="Set Ad" alt="Set Ad" onclick="setAdd('+record[x].record_id+', '+item_id+',\'\','+parent_id+');" /></td>';
                        html += '</tr>';
                    }
                    if(html != ''){
                        $('#advertisement_tbody_master').html(html);
                        $('#advertisement_tbody_master_row').removeClass('hide');
                    }
                }
                $('.admin-loading-image').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 547)');
                $('.admin-loading-image').hide();
            }
        });
    }
    
    function setAdd(ad_id,item_id,ad_update_id,parent_id){
        $('.admin-loading-image').show();
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'get_advertisement_profile', record_id: ad_id},
            success: function (response) {
                var obj = JSON.parse(response);
                if (obj.status == 'OK' && obj.record_id != '') {
                    var record = obj.info.records[0];
                    //var set_ad = $('#set_ad_'+ad_id).is(':checked');
                    var apply_child = $('#apply_child_'+ad_id).is(':checked');
                    var ad_order = $('#ad_order_'+ad_id).val();
                    /*if(ad_update_id != ''){
                        set_ad = true;
                    }*/
                    //if(set_ad == true){
                        $.ajax({
                            ...
                            type: "post",
                            data: {
                                mode: 'upload_advertisement', 
                                ad_item_id: item_id,
                                ad_title: record.ad_title,
                                ad_url: record.ad_url,
                                ad_sort_order: (ad_order != '') ? ad_order : '1',
                                ad_alt_title: record.ad_alt_title,
                                inherit_flag: (apply_child == true) ? '1' : '0',
                                record_ref: ad_id,
                                disable_flag: 'N',
                                ad_update_id: ad_update_id
                                //uploaded_image: record.original_file,
                            },
                            //contentType: false,
                            //cache: false,
                            //processData: false,
                            success: function (response) {
                                ...
                                if (record.status == 'OK' && record.record_id != '') {
                                    var au = (ad_update_id) ? 'updated' : 'added';
                                    showPopupMessage('success', 'Advertisement '+au+' successfully');
                                    getAdvertisement(parent_id, item_id);
                                }
                                $('.admin-loading-image').hide();
                            },
                            error: function () {
                                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 548)');
                                $('.admin-loading-image').hide();
                            }
                        });
                    /*}else{
                        showPopupMessage('error', 'Select apply ad checkbox.');
                    }*/
                }
                $('.admin-loading-image').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 549)');
                $('.admin-loading-image').hide();
            }
        });
    }
    
    function deleteAd(record_id,item_id,parent_id){
        $('.admin-loading-image').show();
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            ...
            success: function (response) {
                var obj = JSON.parse(response);
                if (obj.status == 'OK') {
                    showPopupMessage('success', 'Advertisement removed successfully.');
                    getAdvertisement(parent_id, item_id);
                }
                $('.admin-loading-image').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 550)');
                $('.admin-loading-image').hide();
            }
        });
    }

    function setWatermark(item_id,downLoadWM=0) {
        resetWatermarkForm();
        if (item_id) {
            $('#wm_item_id').val(item_id);
            $('#watermark_popup').modal('show');
            getWatermark(item_id,downLoadWM);
        } else {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 551)');
        }
    }
    
    function resendVerificationLink(user_id){
        $('.admin-loading-image').show();
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'send_verification_link_again', user_id: user_id},
            success: function (response) {
                var obj = JSON.parse(response);
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 552)');
                $('.admin-loading-image').hide();
            }
        });
    }
    
    function fullValidateAccount(archive_id){
        $('.admin-loading-image').show();
        $.ajax({
            type: 'POST',
            url: 'services_admin_api.php',
            data: {mode:'full_validate_account',archive_id:archive_id},
            success: function (response) {
                var record = JSON.parse(response);
                console.log(record);
                showPopupMessage(record.status, record.message);
    ...
    function getWatermark(item_id,downLoadWM=0) {
        resetWatermarkForm();
        $('.admin-loading-image').show();
		$('#archive_download_watermark_div').show();
		if(downLoadWM==0){
			$('#archive_download_watermark_div').hide();
		}
        $.ajax({
            url: "services_admin_api.php",
            type: "post",
            data: {mode: 'fetch_archive_watermark_text', item_id: item_id},
            success: function (response) {
                var obj = JSON.parse(response);
                if (obj.status == 'OK') {
                    var watermark = obj.info.records.archive_watermark_text;
                    if (watermark && watermark != '') {
                        watermark = watermark.trim();
                    }
                    $('#archive_watermark_text').val(watermark);
					/************* SS FIX START 0002309   21-Sep-2023 ************************/
					var watermark_d = obj.info.records.archive_download_watermark_text;
                    if (watermark_d && watermark_d != '') {
                        watermark_d = watermark_d.trim();
                    }
                    $('#archive_download_watermark_text').val(watermark_d);
					/************* SS End START 0002309   21-Sep-2023 ************************/
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 553)');
                $('.admin-loading-image').hide();
                resetWatermarkForm();
            }
        });
    ...
    function resetWatermarkForm() {
        document.getElementById('watermark_frm').reset();
    }

    $(document).ready(function () {
        $(document).on('click', '#watermark_frm_sub', function (e) {
            e.preventDefault();
            var wm_item_id = $('#wm_item_id').val();
            var archive_watermark_text = $('#archive_watermark_text').val();
			 var archive_download_watermark_text = $('#archive_download_watermark_text').val();
            if (wm_item_id == '') {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 554)');
                return false;
            }/* else if (archive_watermark_text == '') {
                $('#archive_watermark_text').focus();
                showPopupMessage('error', 'Watermark text is required');
                return false;
            }*/ else {
                $('.admin-loading-image').show();
                $.ajax({
                    ...
                    type: "post",
					/************* SS FIX START 0002309   21-Sep-2023 ************************/
                    data: {mode: 'save_archive_watermark_text', wm_item_id: wm_item_id, archive_watermark_text: archive_watermark_text,archive_download_watermark_text:archive_download_watermark_text},
					/************* SS END START 0002309   21-Sep-2023 ************************/
                    success: function (response) {
                        var obj = JSON.parse(response);
                        if (obj.status == 'OK') {
                            showPopupMessage('success', 'Watermark saved successfully.');
                        }
                        $('.admin-loading-image').hide();
                        $('#watermark_popup').modal('hide');
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 555)');
                        $('.admin-loading-image').hide();
                        resetWatermarkForm();
                    }
                });
	...
	/*<!-- Start Fixed Issue ID 2138 02-Jan-2023  -->*/
	   function enableDisbaleDownload(item_id,download_status){
        $('.admin-loading-image').show();
        $.ajax({
            type: 'POST',
            url: 'services_admin_api.php',
            data: {mode:'enable_disable_download',item_id:item_id,download_status:download_status},
            success: function (response) {
                var record = JSON.parse(response);
				if(download_status==1)
					{
						$('#enableButtonSpan'+item_id).show();
						$('#disableButtonSpan'+item_id).hide();
					}
				else{
					
						$('#enableButtonSpan'+item_id).hide();
						$('#disableButtonSpan'+item_id).show();
	...
	/*	<!-- Start Fixed Issue ID 2378 05-Mar-2024  -->	*/
	   function remove_location(item_id,download_status){
        $('.admin-loading-image').show();
        $.ajax({
            type: 'POST',
            url: 'services_admin_api.php',
