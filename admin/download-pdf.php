...
if (isset($_REQUEST['item_id']) && $_REQUEST['item_id'] != '' && is_numeric($_REQUEST['item_id'])) {
    ...
    $pdfRequestData["record_summary_header"] = "<br><img src='".SERVER_IMAGE_PATH."/aiblogo.jpg' width='30%' height='0.5'><gotoxy x='0' y='0.75'>";
    $pdfRequestData["item_summary_header"] = "<br><img src='".SERVER_IMAGE_PATH."/aiblogo.jpg' width='30%' height='0.5'><gotoxy x='0' y='0.75'>";
