...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Content Removal</h1>
        <ol class="breadcrumb">
            <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Manage Content Removal</li>
        </ol>
        <h4 class="list_title text-center"><span class="pull-left">Manage Content Removal Request</span> <span class="headingNameDesign"><?php echo $_SESSION['aib']['user_data']['item_title'];?></span></h4>
    </section>
        ...
        <div class="row" id="dataTableDiv">
            <div class="col-md-12 tableStyle">
                 ...
                 <div class="archive-list custom-dropdown left35">
                    ...
                    <div class="archive-list custom-dropdown archive_list_data marginLeft50" style="visibility: hidden;">
                ...
                <table id="content_removal_table" class="display table" width="100%" cellpadding="0" cellspacing="0">  
                    <thead>  
                        <tr> 
...
<script type="text/javascript">
    ...
    $(document).on('click','.view_request_data', function(){
     ...
     var table = $('#content_removal_table').DataTable({"pageLength": 100,"sDom":'<"H"lfrp>t<"F"ip>'});
    ...
    /* $(document).on('click','.edit_request_data', function(){
        var request_id = $(this).attr('data-form-request-id');
        if(request_id){
            $('.admin-loading-image').show();
            $.ajax({
                type: 'POST',
                url: 'services_admin_api.php',
                data: {mode:'get_data_by_request_id',request_id:request_id, type:'edit_request'},
                success: function (response) {
                    $('#request_details_body_section').html(response);
                    $('#request_details_popup').modal('show');
                    $('.admin-loading-image').hide();
