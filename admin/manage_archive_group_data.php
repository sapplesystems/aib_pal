...
.tab-links a {padding:9px 15px;display:inline-block;border-radius:3px 3px 0px 0px;background:#15345a;font-size:16px;font-weight:600;color:#ffffff;transition:all linear 0.15s;}
                ...
                <form class="marginBottom30 formStyle form-group" autocomplete="off" action="" method="POST" id="editArchiveGroupDetails" name="editArchiveGroupDetails" enctype="multipart/form-data">
					<div class="tabs">
						<ul class="nav nav-tabs tab-links" id="myTab" role="tablist">
							<li class="nav-item active border_leftR">
								<a class="nav-link active" id="basic-tab" data-toggle="tab" href="#basic_info" role="tab" aria-controls="basic" aria-selected="true">Basic Information</a>
							</li>
							<li class="nav-item border_leftR">
								<a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact_info" role="tab" aria-controls="contact" aria-selected="false">Contact Information</a>
							</li>
							<li class="nav-item border_leftR">
								<a class="nav-link" id="images-tab" data-toggle="tab" href="#images_info" role="tab" aria-controls="images" aria-selected="false">Images</a>
							</li>
						</ul>
					</div>
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade active in" id="basic_info" role="tabpanel" aria-labelledby="basic-tab">
							...
							<div class="row">
								<div class="col-md-4 text-right">
									<strong>Historical Society Name : 
										<span class="field-tip" id="historical_society_name">
											<img src="public/images/info.png" alt="">
											<span class="tip-content" id="historical_society_name_msg"></span>
										</span>  
									</strong>
								</div>
							...
							<div class="row">
								<div class="col-md-4 text-right">
									<strong>Display Name : 
										<span class="field-tip" id="display_name_s">
											<img src="public/images/info.png" alt="">
											<span class="tip-content" id="display_name_msg"></span>
										</span>  
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<input type="text" class="form-control"  id="display_name"  name="display_name" placeholder="Text input" value="">
								</div> 
							</div>
							<div class="row">
								<div class="col-md-4 text-right"><strong>Tags :
								<span class="field-tip" id="tags">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="tags_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Address :
								<span class="field-tip" id="address">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="address_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>About Content :
								<span class="field-tip" id="about_content">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="about_content_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Detail Description :
								<span class="field-tip" id="detail_description">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="detail_description_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Request Reprint Text :
								<span class="field-tip" id="request_reprint_text">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="request_reprint_text_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Upcoming Events Text :
								<span class="field-tip" id="upcoming_event_text">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="upcoming_event_text_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
						...
						<div class="tab-pane fade" id="contact_info" role="tabpanel" aria-labelledby="contact-tab">
							<div class="row">
								<div class="col-md-4 text-right"><strong>Preferred Time Zone :
								<span class="field-tip" id="preferred_time_zone_s">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="preferred_time_zone_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Contact No. :
								<span class="field-tip" id="contact_no">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="contact_no_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Website :
								<span class="field-tip" id="website">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="website_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<!--<div class="row">
								<div class="col-md-4 text-right"><strong>Facebook Page URL :
								<span class="field-tip" id="website">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="facebook_url_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<input type="text" class="form-control"  id="facebook_page_url"  name="facebook_page_url" placeholder="Text input" value="">
								</div> 
							</div>-->
                            <!-- Fix end for Issue ID 0002417 on 06-Feb-2025 -->
							<div class="row">
								<div class="col-md-4 text-right"><strong>Hours :
								<span class="field-tip" id="hours">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="hours_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Watermark Text :
								<span class="field-tip" id="watermark_text">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="watermark_text_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Display State :
								<span class="field-tip" id="display_state">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="display_state_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Display County :
								<span class="field-tip" id="display_county">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="display_county_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Display City :
								<span class="field-tip" id="display_city">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="display_city_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Display Zip :
								<span class="field-tip" id="display_zip">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="display_zip_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
						...
						<div class="tab-pane fade" id="images_info" role="tabpanel" aria-labelledby="images-tab">
							...
							<div class="row" >
								...
								<div class="col-md-10 col-sm-8 col-xs-12">
									<ul class="nav nav-tabs">
										<li class="active"><a  href="#tab_content_section" data-toggle="tab">Customize Color</a></li>
									</ul>
										...
										<div class="tab-pane active" id="tab_content_section">
											<div class="row">
												<div class="col-md-4">
													...
													<input class="colorpicker" type="text" data-type="heading_font_color" id="heading_color" name="heading_color" value="" autocomplete="false">
												</div>
												<div class="col-md-4">
													<label>Background Color</label>
													<input class="colorpicker" type="text" data-type="content_font_color" id="background_color" name="background_color" value="" autocomplete="false">
												</div>
                                                <!--//Fix start for Issue ID 2179 on 30-March-2023-->
                                                <div class="col-md-4">
                                                    <table class="table">
                                                        <tr>
                                                            <th>Default Heading Color</th>
                                                            <td><span style="background: rgb(252, 200, 84);width: 30px;height: 30px;display: inline-block;border-radius: 10px;"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Default Background Color</th>
                                                            <td><span style="background: rgb(21, 52, 90);width: 30px;height: 30px;display: inline-block;border-radius: 10px;"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <input type="button" class="btn btn-primary pull-right" value="Reset to Default" onclick="resetColor(event);" />
                                                            </td>
                                                        </tr>
                                                    </table>
												</div>
                                                <!--//Fix end for Issue ID 2179 on 30-March-2023-->
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row" style="display:block;">
								<div class="col-md-4 text-right"><strong>Templates :
								<span class="field-tip" id="templates">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="templates_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<ul class="templatesCustom">
                                        ...
                                        <!--Fix start for Issue ID 2146 on 27-Feb-2023-->
										<!--<li>
											<h4>Custom1</h4>
										...
										<li>
											<h4>Custom3</h4>
											<div><img src="<?php echo IMAGE_PATH ?>custom-3.png" alt="" ></div>
											<div><input type="radio" name="custom_template" id="custom3" value="custom3"> <span>Custom3</span></div>
										</li>
										<li>
											<h4>Custom4</h4>
											<div><img src="<?php echo IMAGE_PATH ?>custom-4.png" alt="" ></div>
											<div><input type="radio" name="custom_template" id="custom4" value="custom4"> <span>Custom4</span></div>
										</li>-->
                                        <!--Fix end for Issue ID 2146 on 27-Feb-2023-->
                                        
                                        <!--Fix start for Issue ID 2178 on 22-Feb-2023-->
                                        <!--comment custom 4 template-->
							...
							<div class="row" >
								<div class="col-md-4 text-right"><strong>Details Page Design :
								...
								<div class="col-md-8 col-sm-6 col-xs-12">
									...
									<!--custom-->
									<label for="custom_design">Simplified View</label>
									<input type="radio" value ="large_design" name="details_page_design" group="dpdesign" class="details_page_design" id="large_design">
									<!--custome_1-->
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Logo Image :
								<span class="field-tip" id="logo_image">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="logo_image_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row" >
								<div class="col-md-4 text-right"><strong>Banner Image :
								<span class="field-tip" id="banner_image">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="banner_image_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row" id="society_banner" style="display:none">
								<div class="col-md-4 text-right"><strong>Society Full Banner Image :
								<span class="field-tip" id="society_banner_image">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="society_banner_image_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<input class="archive-details-file-upload" type="file" name="society_archive_header_image" id="society_archive_header_image">
									<span class="help-text custom_temp_crop">(Must be at least 1600 X 600 (Width X Height) )</span>
									<div class="clearfix"></div>
									<img class="archive-details-logo-section" id="society_archive_header_image_post" src="" alt="your image" />
									<a href="javascript:void(0);" class="remove-society-image" property-name="society_archive_header_image"><img title="Remove" src="<?php echo IMAGE_PATH . 'delete_icon.png'; ?>" alt="" /></a>
									<input type="hidden" name="society_archive_header_x" id="society_archive_header_x" />
									<input type="hidden" name="society_archive_header_y" id="society_archive_header_y" />
									<input type="hidden" name="society_baner_crop_height" id="society_baner_crop_height">
								</div> 
							</div>
							<div class="row">
								<div class="col-md-4 text-right">
									<strong>Promotional Image :
										<span class="field-tip" id="details_image">
											<img src="public/images/info.png" alt="">
											<span class="tip-content" id="details_image_msg"></span>
										</span>
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<!--<div class="row">
								<div class="col-md-4 text-right">
									<strong>Promotional Image URL :
										<span class="field-tip" id="promo_img_url">
											<img src="public/images/info.png" alt="">
											<span class="tip-content" id="promo_img_url_msg"></span>
										</span>
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<input class="archive-details-file-upload" type="text" name="archive_details_image_url" id="archive_details_image_url">
									<div class="clearfix"></div>
								</div> 
							</div>-->
							<div class="row">
								<div class="col-md-4 text-right"><strong>Archive Group Thumb :
								<span class="field-tip" id="archive_group_thumbh">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="archive_group_thumb_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Record Display Page Logo :
								<span class="field-tip" id="record_display_page_logo">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="record_display_page_logo_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Hist. Connection Logo :
								<span class="field-tip" id="hist_connection_logo">
									<img src="public/images/info.png" alt="">
									<span class="tip-content" id="hist_connection_logo_msg"></span>
								</span>
								</strong></div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<div class="row">
								<div class="col-md-4 text-right"><strong>Show Purchase Reprint Button :
										<span class="field-tip" id="show_purchase_reprint">
											<img src="public/images/info.png" alt="Show Purchase Reprint Button">
											<span class="tip-content" id="show_purchase_reprint_msg"></span>
										</span>
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
							...
							<!--/****************** Fix Issue Id 2408 18-dec-2024 ***********/////////-->
							<div class="row">
								<div class="col-md-4 text-right"><strong>"Trending artifacts" section disaplayed on the view record page. :
										<span class="field-tip" id="show_purchase_reprint">
											<img src="public/images/info.png" alt="Would you like to display Trending artifacts on the view record page">
											<span class="tip-content" id="show_purchase_reprint_msg"></span>
										</span>
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<label class="radio-inline"><input type="radio" name="archive_trending_artifacts_view_record" id="archive_trending_artifacts_view_record" value="Y" checked>Enable</label>
									<label class="radio-inline"><input type="radio" name="archive_trending_artifacts_view_record"  value="N"  id="archive_trending_artifacts_view_record_d">Disable</label>
								</div> 
                   			 </div>
							<!--/****************** Fix Issue Id 2408 18-dec-2024 ***********/////////-->
							<!--<div class="row">
								<div class="col-md-4 text-right"><strong>Show Download Button :
										<span class="field-tip" id="show_download_btn">
											<img src="public/images/info.png" alt="">
											<span class="tip-content" id="show_download_btn_msg"></span>
										</span>
									</strong>
								</div>
								<div class="col-md-8 col-sm-6 col-xs-12">
									<label class="radio-inline"><input type="radio" name="archive_show_download_btn" id="button_check_download" value="Y" >Enable</label>
									<label class="radio-inline"><input type="radio" name="archive_show_download_btn"  value="N" checked>Disable</label>
								</div> 
                   			 </div>-->
						</div>
					</div>
...
<!-----------------------------Change Start to Fix Issue Id 1999 on 15-Sep-2022-------------------------------------------->
<div class="modal fade" id="crop_uploading_image" role="dialog" data-keyboard="false" data-backdrop="static">
	<!-----------------------------Change End to Fix Issue Id 1999 on 15-Sep-2022-------------------------------------------->
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="image_display_section">
                ...
                <img class="crop-popup-image-section" id="society_archive_banner_image_pre" src="" alt="your image" style="display:none;" />
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#society_archive_header_image").change(function () {
    ...
    $('#archive_details_image_url').blur(function(){
        var archive_details_image_url = $(this).val();
        if (archive_details_image_url != '' && validURL(archive_details_image_url) == false) {
            $('#archive_details_image_url').focus();
            return false;
        }
    });
    ...
    $(document).on('click', '#editArchiveDetails', function (e) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 478)');
            }
        });
        //}
    });
        ...
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (record.prop_details.display_name) {
                        $('#display_name').val(record.prop_details.display_name);
                    }
			if (record.properties.archive_tags) {
				$('#archive_tags').val(record.properties.archive_tags);
			}
                    if (record.prop_details.archive_details_image_url) {
                        $('#archive_details_image_url').val(record.prop_details.archive_details_image_url);
                    }
                    ...
                    // Fix start for Issue ID 0002417 on 06-Feb-2025
					if (record.prop_details.facebook_page_url) {
                        $('#facebook_page_url').val(record.prop_details.facebook_page_url);
                    }
                    //Fix end for Issue ID 0002417 on 06-Feb-2025
					...
					/****************** Fix Issue Id 2408 18-dec-2024 ***********/////////
					if (record.prop_details.archive_trending_artifacts_view_record == 'N') {
                        $("#archive_trending_artifacts_view_record_d").attr("checked", true);
                    }
					/****************** Fix Issue Id 2408 18-dec-2024 ***********/////////
					if (record.prop_details.archive_show_download_btn == 'Y') {
                        $("#button_check_download").attr("checked", true);
                    }
                    setTimeout(function () {
                    ...
                    if (typeof record.prop_details.custom_template !== 'undefined' && record.prop_details.custom_template == 'custom1') {
                        ...
                        $('.custom_temp_crop').text('(Must be at least 1600 X 800 (Width X Height)) ');
                        $('.browse_home').attr("href", "<?php echo '../'.$browseUrl.'&society_template=' ?>"+record.prop_details.custom_template);
		    }else if (typeof record.prop_details.custom_template !== 'undefined' && record.prop_details.custom_template == 'custom3') {
                        $('#custom3,#custom_design2').attr('checked', true);
                        $('.custom_temp_crop').text('(Must be at least 1600 X 800 (Width X Height)) ');
                        $('.browse_home').attr("href", "<?php echo '../'.$browseUrl.'&society_template=' ?>"+record.prop_details.custom_template);
		    }else if (typeof record.prop_details.custom_template !== 'undefined' && record.prop_details.custom_template == 'custom4') {
                        $('#custom4,#custom_design4').attr('checked', true);
                        $('.custom_temp_crop').text('(Must be at least 1600 X 800 (Width X Height)) ');
                        $('.browse_home').attr("href", "<?php echo '../'.$browseUrl.'&society_template=' ?>"+record.prop_details.custom_template);
						$("#society_banner").show();
                    } else {
                    ...
                    /*details_page_design_checkbox*/
                        if(typeof record.prop_details.custom_template !== 'undefined'){
							if(record.prop_details.details_page_design=='large_design'){
								$('#large_design').attr('checked', true);
                    ...
                    if (record.prop_details.archive_header_image && record.prop_details.archive_header_image !== 'undefined') {
                        ...
                        $('#archive_header_image_post').siblings('a.remove-society-image').hide();
                    			...
                    			if (record.prop_details.society_archive_header_image && record.prop_details.society_archive_header_image !== 'undefined') {
                        $('#society_archive_header_image_post').attr('src', 'tmp/' + record.prop_details.society_archive_header_image);
                        $('#society_archive_header_image_post').show();
                    }else{
                        $('#society_archive_header_image_post').siblings('a.remove-society-image').hide();
                    }
					...
					/*<!---- Fix Start for bug Id 2113  18-jan2023 ---->*/
					if(record.prop_details.heading_color != '' && typeof(record.prop_details.heading_color ) !='undefined'){
                        
						 //Changes start for color and font option
      
						$('#heading_color').colpick({
							layout: 'hex',
							submit: 0,
							colorScheme: 'dark',
							color:'#'+record.prop_details.heading_color,
							onChange: function (hsb, hex, rgb, el, bySetColor) {
								$(el).css('border-color', '#' + hex);
								if (!bySetColor) {
									$(el).val(hex);
						...
						$('#heading_color').css('border-color', '#'+record.prop_details.heading_color);
                    }
					else{
						$('#heading_color').colpick({
							layout: 'hex',
						...
						$('#heading_color').css('border-color', '#fcc854');
					}
                    if(record.prop_details.background_color != '' && typeof(record.prop_details.background_color ) !='undefined'){
						...
						$('#background_color').colpick({
							...
							submit: 0,
							colorScheme: 'dark',
							color:'#'+record.prop_details.background_color,
							onChange: function (hsb, hex, rgb, el, bySetColor) {
								$(el).css('border-color', '#' + hex);
								if (!bySetColor) {
									$(el).val(hex);
						 ...
						 $('#background_color').css('border-color', '#'+record.prop_details.background_color) ;
                    }
					else{
						$('#background_color').colpick({
							layout: 'hex',
						...
						$('#background_color').css('border-color', '#15345a') ;
					}
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 479)');
                }
            });
        }
    }
	...
	$(document).on('click', '#model_close_crop_popup', function (e) {
		...
		}else if($('#type').val()=='archive_group_thumb'){
			
			$('#archive_group_thumb').val('');
		}else if($('#type').val()=='archive_group_details_thumb'){
			
			$('#archive_group_details_thumb').val('');
		}
		else if($('#type').val()=='historical_connection_logo'){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (record.status == 'success') {
					...
					if (record.type == 'society_banner') {
			$('#society_archive_header_image_post').attr('src', record.image);
			$('#society_archive_header_image_post').show();
			$('#society_archive_header_image_post').siblings('a.remove-society-image').show();
		    }
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 480)');
            }
        });
    });
    ...
    function get_state() {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 481)');
                $('.loading-div').hide();
            }
        });
    }
    ...
    function setArchiveProperty(field_name, field_value){
        if(field_name != '' && field_value != ''){
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 482)');
                }
            });
        }
    }
    ...
    $(document).on('click', '.remove-society-image', function(){
        ...
        if(confirm('Are you sure to delete this? Once removed can\'t be undone.')){
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 483)');
                }
            });
        }
    });
    ...
    function validURL(str) {
        ...
        if(n < 0){
            $('#archive_details_image_url').val('http://'+str);
        }*/
        if (!regex.test(str)) {
            $('#archive_details_image_url').val('http://'+str);
            return true;
	...
	getAllHelpMessage('home_page_template');

    //Fix start for Issue ID 2179 on 30-March-2023
    function resetColor(e){
        let heading_color = document.getElementById('heading_color');
        let background_color = document.getElementById('background_color');
        if(heading_color){
            heading_color.style.borderColor = 'rgb(252, 200, 84)';
            heading_color.value = 'fcc854';
        }
        if(background_color){
            background_color.style.borderColor = 'rgb(21, 52, 90)';
            background_color.value = '15345a';
        }
    }
    //Fix end for Issue ID 2179 on 30-March-2023
</script>
