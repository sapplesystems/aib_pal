			...
			foreach($ChildList as $Record)
			{
				...
				switch($EntryType)
				{
					...
					case AIB_ITEM_TYPE_COLLECTION:
						...
						{
							$Line = "<li $IDString onclick=\"fetch_tree_children(event,this,$ItemID);\" class='$CollectionClass'>$LocalTitle</li>";
						}
						else
						{
							$Line = "<li $IDString onclick=\"fetch_tree_children(event,this,$ItemID);\">$LocalTitle</li>";
						}
					...
					case AIB_ITEM_TYPE_SUBGROUP:
						...
						{
							$Line = "<li $IDString onclick=\"fetch_tree_children(event,this,$ItemID);\" class='$SubGroupClass'>$IDBox $LocalTitle</li>";
						}
						else
						{
							$Line = "<li $IDString onclick=\"fetch_tree_children(event,this,$ItemID);\">$IDBox $LocalTitle</li>";
						}
