...
<script type="text/javascript">
    ...
    function getItemDetailsById(folder_id) {
        ...
        $.ajax({
            ...
            error: function () {
                $('.admin-loading-image').hide();
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 629)');
            }
        });
    }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if(record.status == 'success'){
                            ...
                            showPopupMessage('error', record.message + ' (Error Code: 630)');
                            $('.admin-loading-image').hide();
                        } 
                    },
                    error: function () {
                        $('.admin-loading-image').hide();
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 631)');
                    }
                });
            } 
          }
