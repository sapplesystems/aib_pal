    ...
    $(document).ready(function () {
        ...
        if (user_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 265)');
                }
            });
        }
	  ...
	  $.validator.addMethod(
        ...
        if ($("#userUpadatForm").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 266)');
                    $('.loading-div').hide();
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (record.status == 'success') {
                        ...
                        $('.admin-loading-image').hide();
                        showPopupMessage(record.status, 'Invalid old password');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 267)');
                    $('.loading-div').hide();
                }
            });
        }
    ...
    function get_state(){
         ...
         $.ajax({
		    ...
		    var record = JSON.parse(response);
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 268)');
                    $('.loading-div').hide();
                }
         });
    }
    function get_country(){
         ...
         $.ajax({
		    ...
		    var record = JSON.parse(response);
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 269)');
                    $('.loading-div').hide();
                }
         });
    }
