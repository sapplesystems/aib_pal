...
function addPage($data)
{
	...
	$addPageQuery="insert into pagecontent(newspaperId,pub_title,city,state,welcome_text,publogo,publication_website,client_text,page_width,yearbook_archive,survey,copyright_owner)values('".$inserted_id."','".$data['pub_title']."','".$data['city']."','".$data['state']."','".$data['welcome_text']."','".$data['publogo']."','".$data['publication_website']."','".$data['client_text']."','".$data['page_width']."','".$data['yearbook_archive']."','".$data['survey']."','".$data['copyright_owner']."')";
