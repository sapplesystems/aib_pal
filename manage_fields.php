...
var table = $('#myTable').DataTable({"pageLength": 100});
    function get_manage_field(archive_id='') {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 204)');
            }
        });
    }
            ...
            $.ajax({
                ...
                success: function (responseData) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 205)');
                    }
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 206)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 207)');
                }
            },
            error: function () {
                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 208)');
            }
        });
    });
