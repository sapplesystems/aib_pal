...
?>
<style>#crop_uploading_image .modal-body{overflow:auto; padding: 15px;}</style>
<div class="content-wrapper">
    ...
    <section class="content-header"> 
        ...
        <h4 class="list_title text-center"><span class="pull-left">Edit Owner Account</span> <span class="headingNameDesign"><?php echo $_SESSION['aib']['user_data']['item_title'];?></span> </h4>
    </section>
...
//                    }
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 189)');
                }
            });
        }
    }
...
//                        window.location.href = "manage_archive_registration.php?archive_id="+archive_id;
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 190)');
                }
            });
  }
	 	...
	 	$.ajax({
                ...
                success: function (data){
                     ...
                     if(result.status == 'success'){ 
						...
						showPopupMessage('error', 'error','Something went wrong, Please try again. (Error Code: 191)');
                     }
                     $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 192)');
                }
            });
}
...
function get_state(){
         ...
         $.ajax({
		    ...
		    var record = JSON.parse(response);
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 193)');
                    $('.loading-div').hide();
                }
         });
    }
