<div class="content2">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 new_layout">
                <h4 class="aboutSociety content-heading" style="margin-bottom:0px !important;"><span id=""><?=$home_page_title;?></span></h4>
            </div>
            <div class="col-md-2"></div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row posRelative">
            ...
            <div id="dynamic-tree-content" class="col-md-2 col-sm-2 leftModule d-desktop"></div>
            ...
            ?>
            <div id="dynamic-tree-content-bottom" class="col-md-2 leftModule d-mobile def"></div>
