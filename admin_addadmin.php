...
// #########
	...
	$DisplayData = array(
		"page_title" => "SYSTEM ADMINISTRATOR: ADD ADMINISTRATOR",
		"popup_list" => array(
...
?>
<script>
	// Test function for AJAX; sends request
	...
	// Test function for AJAX; processes result from request submitted by test_ajax()
	function test_ajax_update()
	{
	}
