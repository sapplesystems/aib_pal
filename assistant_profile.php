    ...
    $(document).ready(function () {
        ...
        if (user_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 106)');
                }
            });
        }
	  ...
	  $.validator.addMethod(
        ...
        if ($("#userUpadatForm").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 107)');
                    $('.loading-div').hide();
                }
            });
        }
    ...
    $(document).on("click", "#save_pass", function () {
        ...
        if ($("#change_password").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 108)');
                    $('.loading-div').hide();
                }
            });
        }
	 	...
	 	$.ajax({
                ...
                success: function (data){
                     ...
                     if(result.status == 'success'){ 
						...
						showPopupMessage('error', 'error','Something went wrong, Please try again. (Error Code: 109)');
                     }
                     $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 109)');
                }
            });
}
</script>