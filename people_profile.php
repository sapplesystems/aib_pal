...
<script type="text/javascript">
    ...
    function getItemPropDetails(archive_id) {
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 250)');
                }
            });
        }
    }
    function getAdvertisement(folder_id)
    {
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 251)');
            }
        });
    }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(result.status == 'success'){
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 252)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 253)');
            }
        });
    }
});
