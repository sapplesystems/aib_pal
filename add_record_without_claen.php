		...
		<td align='left' valign='top'>
			...
			switch($OpCode)
			{
				...
				case "save":
					...
					header('location:'.AIB_SERVICE_URL.'/admin/manage_my_archive.php?folder_id='.$_REQUEST['parent']);
								exit;
					break;
...
//						"existing_fields" => $FieldsUsed,
			...
			switch($OpCode)
			{
				...
				case "save":
					...
					$TargetSpec[] = array( "url" => "add_record.php", "title" => "Add Another Record","fields" => $TempFields);
					$OutBuffer[] = aib_chain_link_set($TargetSpec);
					break;
