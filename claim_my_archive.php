                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (record.status == 'success') {
                            ...
                            showPopupMessage('error', record.message + ' (Error Code: 1162)');
                        }
                    },
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 111)');
                        $('.loading-div').hide();
                    }
                });
                /*$.ajax({
    ...
    function getItemPropDetails(archive_id, user_id) {
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 112)');
                }
            });
        }
    }
