...
<form name="registrationOtherForm" id="registrationOtherForm" method="post" action="">
    ...
    <div class="content bgThankYou" style="min-height: 700px;">
        <div class="bgThankYou_overlay">
            <div class="container"> 
                    ...
                    <div class="col-md-12">
                        <div class="thankYouText">
                            ...
                            <div class="add_society" id="add_society" <?php echo $society_hide; ?> >
                                 Your Society has been created successfully.<br />
                                <div class="with_user">Thank you for confirming the email</div> 
                            </div>
                            <span id="expirelinkMsj"></span>
                            <div class="without_user" style="display:none">
                                <!--<img src="<?php echo IMAGE_PATH . 'thankYou-icon.png'; ?>" alt="Thank You" /><br />-->Your profile has been created successfully.<br />We will reach out to you with the next steps.
                                <div class="with_user">Thank you for confirming the email</div> 
                            </div>
        ...
        <div class="col-md-6">
          <div class="">
                      ...
                      <div class="col-xs-7 marginTop20">
                        ...
                        <button type="button" class="btn btn-info  borderRadiusNone closepopup" id="notAgreeTermButton">No I do not agree</button>
                            ...
                            <div style="margin-top:20px;">
                                <a class="login_link_page login_link"   href="<?php echo HOST_PATH . 'admin/login.php' ?>"  style="background: #fbd42f;color: #15345a;padding: 10px 40px;display: inline-block;font-size: 16px;text-decoration: none; margin-top: 10px;border-radius: 5px;display:none">Click here to login</a>
                            </div>
                            <br />
            ...
            <div class="backPageLink"><a href="index.php"><img src="<?php echo IMAGE_PATH . 'back-icon.png'; ?>" alt="Thank You" /> Back to HomePage</a></div>
        </div>
    </div>
</form> 
<div class="clearfix"></div>
...
<?php } ?>
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 890)');
                }
            });
        }
    }
    function change_email(user_id, current_email, old_email) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 891)');
            }
        });
    }
