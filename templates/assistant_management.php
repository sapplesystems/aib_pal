<style>.tree-sub-group{list-style: none;}</style>
...
<div class="modal-body" >
    <div class="col-xs-12">
        <div class="box_public_info" style="height: 150px; overflow: auto;">
            <h5>Available Sub Groups</h5>
            <?php
    ...
    <div class="col-xs-12">
        <div class="row">
            <div class="col-xs-6">
                <div class="box_public_info" style="height: 150px; overflow: auto;">
                    <h5 id="selected_from_available">Selected From Available Sub Groups</h5>
                    <div id="selected_from_available_subgroup"><div class="clearfix"></div></div>
                </div>
                <div class="text-center"> 
                    <button type="button" class="btn btn-info borderRadiusNone" name="assigned_assistant_to_subgroup" id="assigned_assistant_to_subgroup">Assign</button>	
                </div>
            </div>
            <div class="col-xs-6">
                <div class="box_public_info" style="height: 150px; overflow: auto;">
                    <h5 id="assigned_sub_group">Assigned Sub Groups</h5>
                    <?php
                ...
                <div class="text-center"> 
                    ...
                    <button type="button" class="btn btn-danger borderRadiusNone" id="unassigned-assistant">Unassign</button>
                </div>
            </div>
        </div>
    </div>
