...
body{overflow:hidden !important;}
	...
	<div class="navBar" style="background:linear-gradient(180deg, #0C0606B8 10%, #FFFFFF00 100%);    height: 215px;">
	<div class="container heritage_container">
	<div class="row">
	<div class="col-md-12">
			<ul>
				<li class="active pull-left"><a href="#">Home</a></li>
				<li class="hov pull-left"><a href="#">About</a>
					<ul class="main">
				...
				<li class="hov pull-left"><a href="#">Get Involved</a>
					<ul class="main">
                ...
                <li class="hov pull-right"><a href="#">How Do I…</a>
					<ul class="main">
						<li><a href="http://staging.pacificgroveheritage.org/contact-us/">Contact Us</a></li>
					</ul>
				</li>
                <li class="pull-right"><a href="#">Events</a></li>
				<li class="hov pull-right"><a href="#">Archives</a>
					<ul class="main">
            ...
            <div class="member_btn_div text-center">
                <h1>EST 1975</h1>
                <p>Fostering an appreciation of the City's historical and architectural resources.</p>
                    <a href="#" class="member_btn">BECOME A MEMBER</a>
             </div>
	...
	<div class="footer_bar">
		...
		<div class="row">
		<div class="col-md-8">
		<p class="marginBottomNone">© 2021 – The Heritage Society of Pacific Grove | Web Design by <a class="linkColor" href="https://mckindercreative.com">McKinder Creative</a></p>
	</div>
    ...
    function getItemPropDetails(archive_id) {
        ...
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1050)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1051)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 1052)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 1053)');
                }
                $('.loading-div').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1054)');
            }
        });
    }
</script> 	
