...
<style>
.customSlider ul.imageDisplay li.resizeLi{width:107px !important;}
 .customSlider .height90 {height: 64px !important;}
.customSlider .ch-info_size {height: 54px !important;width: 90px !important;}
.customSlider ul.imageDisplay li{margin:7px !important;}
.customSlider #content-slider-item{height: 110px !important;}
.customSlider .lSAction > .lSPrev{left:0px !important;}
.customSlider .lSAction > .lSNext{right:0px !important;background-position: -23px 0 !important;}
.custom_historical_head{font-size: 13px !important; padding: 5px 10px !important;}
.customSlider .lSAction > a{background-size: 200% !important; width: 22px !important; height: 22px !important; background-repeat:no-repeat !important;}
.customSlider .ch-info-back{display: table;overflow: hidden;}
</style>

<script src="<?php echo JS_PATH . 'lightslider.js'; ?>"></script>
<script type="text/javascript">
    $(document).ready(function(){
        $("#content-slider-item").lightSlider({
            loop:false,
            keyPress:false,
            item: 2,
            pager: false
...
<div id="tab6" class="tab-contentH item customSlider">
    ...
    if (!empty($relatedItemsData)) {
        ...
        ?>
        <ul id="content-slider-item" class="content-slider imageDisplay">
            <?php
            $previous_item = [];
            $count = 0;
