...
?>
<style>
    marquee{max-height:calc(100vh - 475px); min-height:320px !important;max-height: 553px !important;}
    marquee a{margin:10px 0;display: block;border: 1px solid #cccccc; text-align:center; padding:10px;}
</style>
<div class="sliderBackground">
    <div class="container relativePos">
        <div class="arrowSlider">
            <?php if($preKeyId !=''){ ?>
                <a href="javascript:pageMoveToItemDetail(<?php echo $preKeyId; ?>)" class="backToBtn leftArrw"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> <span class="arrow_text">Previous Record</span></a>
            <?php } ?>
            <?php if($nextKeyId !=''){ ?>
                <a href="javascript:pageMoveToItemDetail(<?php echo $nextKeyId; ?>)" class="viewToBtn rightArrw"><span class="arrow_text">Next Record</span> <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span></a>
            <?php } ?>
        </div>
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                ...
                <div class="relativePos">
                    <div class="imageSldr sapple-slider-item <?php if(count($apiResponse['info']['records']) <= 0 && $private_records == 'yes'){ echo 'no-item-found'; }elseif(count($apiResponse['info']['records']) <= 0 && $private_records == ''){ echo "no-item"; } ?>" id="sapple-slider-item-0" item-count="0">
                        <div class="relativePos">
                            <img  class="show_large_image" src="images/slider-img.jpg" alt="Slider Image" onload="largeHighLightImage()" />
                        </div>
                    </div>
                ...
                <div class="imageDesription">
                    <div class="padding15">
                        ...
                        <div class="pull-right">
                            <div id="back_to_scrapbook" <?php echo $scrapbook_hide; ?>>
                            <a  href="javascript:void(0);" class="backToBtn">Back to Scrapbook</a>&nbsp;
                            </div>
                            <a id="scrollToComments" href="javascript:void(0);" class="viewToBtn">View Comments</a>
                        </div>
                    </div>
                    <div class="padding15 borderBtmNone maxHeight400">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php if ($is_unclaimed_society && $is_unclaimed_society == '1') { ?>
                                            <input type="button" class="btn claim_this_historical_custom" onclick="openClaimPopup(event);" value="Claim This Historical" />
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="col-md-3">
                                <img id="client_logo" class="historical_Logo" src="<?php echo ARCHIVE_IMAGE.$archive_logo ; ?>" alt="Historical Logo" />
                            </div>
                        </div>
                        <!--<div class="seemore_details"><span>See more details</span> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></div> -->
                    </div>
                </div>
            </div>
        </div>
...
<div class="bgThumbnail">
    <div class="thumbnailList">
        <div class="leftArrow_details left-arrow-section"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></div>
        <div class="rightArrow_details right-arrow-section"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></div>
    ...
    <div class="backSearch viewToBtn" id="backDivURL"><a class="" id="backURL" href=""><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Back to Search</a></div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-8"><!--text-center-->
            <ul class="beardcrumb_archive">
                <li><a href="index.html"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <img src="public/images/arrow_breadcrumb.png" alt="Arrow Breadcrumb" /></a></li>
                <?php $arrayKeys=array_keys($treeDataArray);$count=0;
                    ...
                    foreach ($treeDataArray as $key => $treeData) {
                        ...
                        if($treeData['item_type']=='AG' and $count==0){ ?>
                            <li><a href="society.html?q=<?php echo encryptQueryString('folder-id='.$treeData['item_id'].'&society_template='.$society_template);?>"><?php echo $treeData['item_title'] ?> <img src="public/images/arrow_breadcrumb.png" alt="Arrow Breadcrumb" /></a></li>
                            <?php	
                            $itemDisTitle='Archives';$count++;
                        }else if(($treeData['item_type']=='CO' || $treeData['item_type']=='AR') and  $count==0){ ?>
                            <li><a href="/people_profile.html?q=<?php echo encryptQueryString('folder-id='.$treeData['item_id']);?>"><?php echo $treeData['item_title'].' Home';?> <img src="public/images/arrow_breadcrumb.png" alt="Arrow Breadcrumb" /></a></li>
                        <?php	
                            $itemDisTitle='Archives';$count++;
                        }
                        ?>
                ...
                <?php } else { ?>
                    <li data-folder-id="<?php echo $treeData['item_id']; ?>"><a href="<?php echo $redirect_file_name;?>?q=<?php echo encryptQueryString('folder_id='.$treeData['item_id'].'&society_template='.$society_template); ?>"><?php echo $itemDisTitle; ?> <img src="public/images/arrow_breadcrumb.png" alt="Arrow Breadcrumb" /></a></li>
                <?php }
            }
            ?>
            </ul>
...
<div class="container-fluid"><!--minHeight450--><!-- positionRelative -->
    <div class="row">
        <div class="col-md-2 leftModule rightPaddingNone">
            <div class="thumbnail_slider_historical historical_connection_top">
                <h3>HISTORICAL CONNECTIONS</h3>
                <div id="historical_connection_data_top"></div>
                <!--<a href="javascript:void(0);" class="topArrow_slider"><span class="glyphicon glyphicon-menu-up" aria-hidden="true"></span></a>
                <a href="javascript:void(0);" class="bottomArrow_slider"><span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a>-->
            </div>
        </div>
        <div class="col-md-8 marginTopMobile centerModule leftPaddingNone"> 
            <div class="tab_archive">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#related_content_section" aria-controls="home" role="tab" data-toggle="tab">RELATED CONTENT</a></li>
                    <li role="presentation"><a href="#public_connection_content_section" aria-controls="profile" role="tab" data-toggle="tab">PUBLIC CONNECTIONS</a></li>
                    <li role="presentation" class="commentsSection"><a href="#tabs-2" aria-controls="profile" role="tab" data-toggle="tab">COMMENTS</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="related_content_section"></div>
                    <div role="tabpanel" class="tab-pane" id="public_connection_content_section"></div>
        ...
        <div class="col-md-2 rightModule">
            <div class="ad_archive marginTop50 marginBottom20" id="adver"></div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body padd_f location_top">
				...
				<div class="positionRelative">
                                ...
                                <p class="imgDetailsDesc">
                                    <strong>Record Name :</strong> <span class="record_name"> <?php end($treeDataArray);
                ...
                if ($(this).css("display") == "block") {
                    ...
                    var height = $(window).height();
                        $.ajax({
                            ...
                            error: function () {
                                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 900)');
                            }
                        });
    ...
    function getPrimaryImageData(pr_file_id, item_type, data_url, searchString= '', item_id = '') {
        ...
        if(pr_file_id !=''){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 901)');
                }
            }); 
        }else{
    ...
    function getItemCustomFields(item_id,ref_id) {
	    ...
	    $('.loading-div').show();
		    ...
		    $('.loading-div').hide();
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 902)');
                }
            });
        }
    }
    ...
    function getItemDetails(item_id) {
        if (item_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 903)');
                }
            });
        }
    }
    ...
    function getItemArchiveProperty(record_id) {
        if (record_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 904)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 905)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 906)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 907)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 908)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 909)');
                        setTimeout(function(){
                            $('.loginPopup').trigger('click');
                        },1000);
                    }else{
                        showPopupMessage('error', result.message + ' (Error Code: 910)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 911)');
                }
            });
        }
    });
    ...
    function listCommentThreads(parent_folder_id,action) {
        ...
        if (parent_folder_id) { 
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 912)');
                }
            });
        }
    }
    ...
    function deleteCommentFromThread(obj_id){
        if (obj_id) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 913)');
                }
            });
        }
    }
    function addCommentToThread(obj) {
        ...
        if (parent_thread) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 914)');
                }
            });
        }
    }
        ...
        $("#txtUserComments").keyup(function(e){
            ...
            if (e.keyCode == 13 && jQuery.trim(this.value)!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 915)');
                    }
                });
            }
        });
        ...
        $("#post-your-comments").on("click",function(){
            if (jQuery.trim($("#txtUserComments").val())!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 916)');
                    }
                });
            }
        });
...
$(document).on('click', '#load_comments_details_page', function(){
    ...
    function getRelatedItems(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 917)');
                }
            });
        }
    } 
	...
	function getPublicConnections(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 918)');
                }
            });
        }
    }
    function get_public_username(email){
         ...
         $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 919)');
            }
        });
    }
...
$('#linkPubConBtn').click(function(){
	...
	$.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 920)');
            }
        });
 ...
 function getScrapbookRecordDetails(record_id){
          $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 921)');
            }
        });
	...
	$(document).on("click" ,".report-user",function(){
        ...
        $(document).on("click","#report_submit",function(){
                       ...
                       $.ajax({
                        ...
                        error: function () {
                            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 922)');
                        }
                });
        });        
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(record.status == 'success'){
                        ...
                        showPopupMessage(response.status, response.message + ' (Error Code: 923)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 924)');
                }
            });
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(record.status == 'success'){
                ...
                showPopupMessage(response.status, response.message + ' (Error Code: 925)');
            }
        },
        error: function () {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 926)');
        }
    });
});
...
function getSavedScrapbookTitle(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 927)');
            }
        });
    }
}
...
function getItemOcrData(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 928)');
            }
        });
    }
}
...
function getItemDescription(item_id) {
    if (item_id) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 929)');
            }
        });
    }
}
