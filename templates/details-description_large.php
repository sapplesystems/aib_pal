                ...
                <div class="sapple-slider">
                    <div class="sapple-slider-banner">
                        <div class="banner-slider">
							...
							<!--/****************** Fix start Issue Id 2408 18-dec-2024 ***********/////////-->
                            <div class="trending-img" <?php echo $archive_trending_artifacts_view_record_hide;?>>
								<!--/****************** Fix End Issue Id 2408 18-dec-2024 ***********/////////-->
...
//                                        $indexCount = 1;
						...
						<div class="itemDetailImageNumb"><?php echo $item_count + 1; ?></div>
                            ...
                            <!------- Fix start for Issue ID 2141 on 17-Jan2023 ---->
                             ...
                             <!-- <div class="pull-right" id="backDivURL"><a class="backtoLink" id="backURL" href="javascript:history.back()" onclick="history.back(); return false;"><img src="<?php //echo IMAGE_PATH . 'back-to-search.png'; ?>" alt=""> <span>Back To Search</span></a></div> -->
        ...
        <div class="rightBox hConnection">
            <div>
                <div class="relatedContent_div">
					...
					<!-- fix issue on 14-July-2023 -->	
						
						
						<div class="row">
							<div class="col-md-12">
								<div class="accordion-contianer">
    <button class="accordion">Description <span id="desc_count"></span></button>
    <div class="panel">
      <div id="tabs-1"></div>
    </div>
  </div>
  ...
  <div class="accordion-contianer">
    <button class="accordion">
		Related Content <span id="rel_con_count"></span>
                                            <span class="field-tip field-tip-override" id="related_content_name">
                                                <img src="public/images/question_icon.png" alt="">
                                                <span class="tip-content" id="related_content_msg">Related Content</span>
                                            </span></button>
    <div class="panel">
      <div id="related_content_section"></div>
    </div>
  </div>

  <div class="accordion-contianer">
    <button class="accordion">
	Historical Connection <span id="his_con_count"></span>
                                            <span class="field-tip field-tip-override" id="historical_connection_name">
                                                <img src="public/images/question_icon.png" alt="">
                                                <span class="tip-content" id="historical_connection_msg">Historical Connection</span>
                                            </span>
  ...
  <div class="accordion-contianer">
    <button class="accordion">
		Public Connection <span id="pub_con_count"></span>
                                            <span class="field-tip field-tip-override" id="public_connection_name">
                                                <img src="public/images/question_icon.png" alt="">
                                                <span class="tip-content" id="public_connection_msg">Public Connection</span>
                                            </span>
    ...
    <div class="panel">
      <div id="public_connection_content_section"></div>
    </div>
  </div>
  
  <div class="accordion-contianer">
    <button class="accordion">
		Comments <span id="comments_count"></span>
	</button>
    <div class="panel">
      <div id="tabs-2">
			 <h4 class='headingComment'>Comments <button class="btn btn-success pull-right" id="load_comments_details_page">Load Previous Comments</button></h4>                    
...
-->
					...
					<!----------- Issue Id 2108 Fix End date 12-Dec-2022--------------->
						...
						<!------- Fix start for Issue ID 2141 on 17-Jan2023 ---->
									...
									<!------- Fix End for Issue ID 2141 on 17-Jan2023 ---->
                <?php if($nextKeyId !=''){ ?>
                     <a href="javascript:pageMoveToItemDetail(<?php echo $nextKeyId; ?>)"><button class="btn nextRecord"> Next Record <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span></button>
                <?php } ?>
            ...
            <div class="modal-body padd_f location_top">
                <div class="fullWidthDiv">
                    ...
                    <div class="display_name" style="top:35% !important">
						...
						<br><br><br><span  style="font-family: arial;    font-weight: bold;    font-size: 16px;">Hover over a pin to see a list of records that are linked to a location.<br><br>Click  on a record name to open the record in a new window.</span>
						<br><br><br>
                ...
                if ($(this).css("display") == "block") {
                    ...
                    var height = $(window).height();
                        $.ajax({
                            ...
                            error: function () {
                                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 990)');
                            }
                        });
    ...
    function getPrimaryImageData(pr_file_id, item_type, data_url, searchString= '', item_id = '') {
        ...
        if(pr_file_id !=''){
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 991)');
                }
        }); 
        }else{
            var noImage ='<div class="imgCenterSlider"> <iframe id="youtubeIframe" style="display: none;"  width="560" height="615" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>				<img  id="mainImage" class="show_large_image" src="'+image_url+'no-image.png" alt="Slider Image" onload="largeHighLightImage()"></div>';
    ...
    function getItemCustomFields(item_id,ref_id) {
	    ...
	    $('.loading-div').show();
		    ...
		    $('.loading-div').hide();
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 992)');
                }
            });
        }
    }
    ...
    function getItemDetails(item_id) {
        ...
        if (item_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 993)');
                }
            });
        }
    }
    ...
    function getItemArchiveProperty(record_id) {
        if (record_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 994)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 995)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 996)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 997)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 998)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 999)');
                        setTimeout(function(){
                            $('.loginPopup').trigger('click');
                        },1000);
                    }else{
                        showPopupMessage('error', result.message + ' (Error Code: 1000)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 1001)');
                }
            });
        }
    });
    ...
    function listCommentThreads(parent_folder_id,action) {
        ...
        if (parent_folder_id) { 
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1002)');
                }
            });
        }
    }
    ...
    function deleteCommentFromThread(obj_id){
        if (obj_id) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1003)');
                }
            });
        }
    }
    function addCommentToThread(obj) {
        ...
        if (parent_thread) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1004)');
                }
            });
        }
    }
        ...
        $("#txtUserComments").keyup(function(e){
            ...
            if (e.keyCode == 13 && jQuery.trim(this.value)!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1005)');
                    }
                });
            }
        });
        ...
        $("#post-your-comments").on("click",function(){
            if (jQuery.trim($("#txtUserComments").val())!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1006)');
                    }
                });
            }
        });
...
$(document).on('click', '#load_comments_details_page', function(){
    ...
    function getRelatedItems(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 1007)');
                }
            });
        }
    } 
	...
	function getPublicConnections(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 1008)');
                }
            });
        }
    }
    function get_public_username(email){
         ...
         $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1009)');
            }
        });
    }
...
$('#linkPubConBtn').click(function(){
	...
	$.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 1010)');
            }
        });
 ...
 function getScrapbookRecordDetails(record_id){
          $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 1011)');
            }
        });
	...
	$(document).on("click" ,".report-user",function(){
        ...
        $(document).on("click","#report_submit",function(){
                       ...
                       $.ajax({
                        ...
                        error: function () {
                            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1012)');
                        }
                });
        });        
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(record.status == 'success'){
                        ...
                        showPopupMessage(response.status, response.message + ' (Error Code: 1013)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1014)');
                }
            });
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(record.status == 'success'){
                ...
                showPopupMessage(response.status, response.message + ' (Error Code: 1015)');
            }
        },
        error: function () {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1016)');
        }
    });
});
...
function getSavedScrapbookTitle(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 1017)');
            }
        });
    }
}
...
function getItemOcrData(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 1018)');
            }
        });
    }
}
...
function getItemDescription(item_id) {
    if (item_id) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1019)');
            }
        });
    }
}
...
// fetch the metadata , and if meta data is present , set the lat1 and lat2 to the metadata location lat and lng
  ...
  // set by default.
			  ...
			  $('#largeMapRecodInfo').html("<?php echo $itemrecord_address_info_large_map;?>");
	$('#MapAddress').show();
			const mapsnew = new google.maps.Map(document.getElementById("googleMapStreet"), {
    zoom: 14,
    center: { lat: <?php echo $itemrecord_lat;?>, lng: <?php echo $itemrecord_lng;?> },
	   mapTypeId: "satellite",
