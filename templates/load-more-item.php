                ...
                <?php if (isset($itemDataArray['stp_url']) && $itemDataArray['stp_url'] != '' && $itemDataArray['link_type'] == 'A') { ?>
                    <td>
						...
						<!--- Fix start SS Issue Id 2306  14Aug 2023 ---->
                                    <h6 class="recordHead"  title="<?php echo urldecode($itemDataArray['item_title']); ?>">
                                        <?php
						...
						<!--- Fix end SS Issue Id 2306  14Aug 2023 ---->
                                    ...
                                    ?>">
                                            ...
                                            <div class="mask">
                                                ...
                                                <a class="custom-link details-page-url url-append animate-load-more" data-folder-id="<?php echo $itemDataArray['item_id']; ?>" item-id="<?php echo $itemDataArray['item_id']; ?>" child-count="<?php echo $itemDataArray['child_count']; ?>" item-type="<?php echo $itemDataArray['item_type']; ?>" item-parent="<?php echo $itemDataArray['link_properties']['item_parent']; ?>" href="javascript:pageMoveToItemDetail(<?php echo $itemDataArray['item_id']; ?>,<?php echo $itemDataArray['child_count']; ?>);">
