				...
				var itemrecord_lng_old=Number("<?php echo $itemrecord_lng;?>");
				 $.each(record['data'], function(key, value){
					...
					if(item_id_c==value.item_id_c){
						...
						map: mapLarge,
						 icon: "<?php echo HOST_ROOT_IMAGE_PATH;?>map-icon.png"
					  });
					}
					 else{
						 marker = new google.maps.Marker({
					  ...
					  // Prevent webpage zoom when cursor is over the info window
   /*   google.maps.event.addListener(infowindow, 'domready', function() {
        var infoWindowElement = document.querySelector('.gm-style-iw');
        if (infoWindowElement) {
          infoWindowElement.parentElement.parentElement.style.pointerEvents = 'none';
        }
      });*/
					 if(item_id_c!=value.item_id_c){
