...
.custom_width_content .col-md-2{
    width: 11.667%;
}

.custom_width_content .col-md-8{
    width: 76.667%;
}
</style>


<div class="sliderBackground bgGradient_head marginBottom20">
    <div class="container-fluid relativePos">
        ...
        <div class="thumbnailLeft_Div">
                ...
                <?php
                    if (count($apiResponse['info']['records']) > 0) {
                        ...
                        foreach ($apiResponse['info']['records'] as $itemDataArray) {
                            ...
                            <?php
                            $item_count++;
                            if ($item_count % 5 == 0 && count($apiResponse['info']['records']) > ($indexCount * 5)) {
                                $indexCount++;
                                ?>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12"><!--ml100_minus-->
                <div class="imageSldr">
                    <div class="relativePos">
                        ...
                        <div class="relativePos">
                            ...
                            <div class="slideDigit pagination-counter">
                                <?php if($preKeyId !=''){ ?>
                                <a class="leftSlideArrow" href="javascript:pageMoveToItemDetail(<?php echo $preKeyId; ?>)">
                                    <img src="public/images/slider-arrow-left.png" alt="Slider Arrow" />
                                </a>
                                <?php } ?>
                                <?php if($nextKeyId !=''){ ?>
                                <a class="rightSlideArrow" href="javascript:pageMoveToItemDetail(<?php echo $nextKeyId; ?>)">
                                    <img src="public/images/slider-arrow-right.png" alt="Slider Arrow" />
                                </a>
                                <?php } ?>
                                <div class="digit counter">
                                    ITEM <span class="current">1</span> OF 
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="imageDesription">
                    ...
                    <div class="padding15 marginTop20">
                        <div class="row">
                            <div class="col-md-12 posAbsoluteBtn">
                                <ul class="btnAction">
            ...
            <div class="col-md-2 col-sm-2 col-xs-12" id="top_right_position"><!--addWidth_custom-->
                <?php include_once 'advertisement2.php'; ?>
                <!--img style="max-width: 100%;" src="public/images/ad_google.jpg" /-->
            </div>
        </div>
    </div>
        ...
        <div class="row posRelative">
            ...
            <div class="col-md-10 col-sm-10">
                <div class="arrowSliderBtn">
                    ...
                    <?php }else{ ?>
                        <a class="Previous_Record" style="visibility: hidden;" href="javascript:void(0);">Previous Record</a>
                    <?php } ?>
                        <a class="this_Record" href="javascript:void(0);">This Record</a>
                    <?php if($nextKeyId !=''){ ?>
                        <a class="Next_Record" href="javascript:pageMoveToItemDetail(<?php echo $nextKeyId; ?>)">Next Record</a>
                    <?php }else{ ?>
                        <a class="Next_Record" style="visibility: hidden;" href="javascript:void(0);">Next Record</a>
                    <?php } ?>
                </div>
            </div>
        </div>
...
<div class="container marginBottom30">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="sliderMain_heading marginTop10">Historical <span>Items</span></h1>
        </div>
    </div>
	
	<div class="row">
        <div class="col-md-12" id="historical_connection_data">
            <!--div id="historical_connection_data"></div-->
            <!--div class="slider one-time">
                <div class="multiple"><img src="public/images/TS1.jpg" /></div>
                <div class="multiple"><img src="public/images/collage_eight.jpg" /></div>
                <div class="multiple"><img src="public/images/collage_eleven.jpg" /></div>
                <div class="multiple"><img src="public/images/collage_four.jpg" /></div>
                <div class="multiple"><img src="public/images/collage_seven.jpg" /></div>
                <div class="multiple"><img src="public/images/collage_six.jpg" /></div>
            </div-->
        </div>
    </div>
</div>

<div class="relatedContent_div"><!--custom_width_content-->
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-9" id="sliderMain_heading">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div id="bottom_left_position">
                    <?php include_once 'advertisement3.php'; ?>
                    <!--img style="max-width: 100%;" src="public/images/ad_google.jpg" /-->
                </div><br>
                <div id="bottom_right_position">
                    <?php include_once 'advertisement4.php'; ?>
                    <!--img style="max-width: 100%;" src="public/images/ad_google.jpg" /-->
                </div>
            </div>
        </div>
                ...
                if ($(this).css("display") == "block") {
                    ...
                    var height = $(window).height();
                        $.ajax({
                            ...
                            error: function () {
                                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 960)');
                            }
                        });
    ...
    function getPrimaryImageData(pr_file_id, item_type, data_url, searchString= '', item_id = '') {
        ...
        if(pr_file_id !=''){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 961)');
                }
            }); 
        }else{
    ...
    function getItemCustomFields(item_id,ref_id) {
	    ...
	    $('.loading-div').show();
		    ...
		    $('.loading-div').hide();
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 962)');
                }
            });
        }
    }
    ...
    function getItemDetails(item_id) {
        if (item_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 963)');
                }
            });
        }
    }
    ...
    function getItemArchiveProperty(record_id) {
        if (record_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 964)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 965)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 966)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 967)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 968)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 969)');
                        setTimeout(function(){
                            $('.loginPopup').trigger('click');
                        },1000);
                    }else{
                        showPopupMessage('error', result.message + ' (Error Code: 970)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 971)');
                }
            });
        }
    });
    ...
    function listCommentThreads(parent_folder_id,action) {
        ...
        if (parent_folder_id) { 
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 972)');
                }
            });
        }
    }
    ...
    function deleteCommentFromThread(obj_id){
        if (obj_id) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 973)');
                }
            });
        }
    }
    function addCommentToThread(obj) {
        ...
        if (parent_thread) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 974)');
                }
            });
        }
    }
        ...
        $("#txtUserComments").keyup(function(e){
            ...
            if (e.keyCode == 13 && jQuery.trim(this.value)!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 975)');
                    }
                });
            }
        });
        ...
        $("#post-your-comments").on("click",function(){
            if (jQuery.trim($("#txtUserComments").val())!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 976)');
                    }
                });
            }
        });
...
$(document).on('click', '#load_comments_details_page', function(){
    ...
    function getRelatedItems(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 977)');
                }
            });
        }
    } 
	...
	function getPublicConnections(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 978)');
                }
            });
        }
    }
    function get_public_username(email){
         ...
         $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 979)');
            }
        });
    }
...
$('#linkPubConBtn').click(function(){
	...
	$.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 980)');
            }
        });
 ...
 function getScrapbookRecordDetails(record_id){
          $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 981)');
            }
        });
	...
	$(document).on("click" ,".report-user",function(){
        ...
        $(document).on("click","#report_submit",function(){
                       ...
                       $.ajax({
                        ...
                        error: function () {
                            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 982)');
                        }
                });
        });        
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(record.status == 'success'){
                        ...
                        showPopupMessage(response.status, response.message + ' (Error Code: 983)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 984)');
                }
            });
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(record.status == 'success'){
                ...
                showPopupMessage(response.status, response.message + ' (Error Code: 985)');
            }
        },
        error: function () {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 986)');
        }
    });
});
...
function getSavedScrapbookTitle(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 987)');
            }
        });
    }
}
...
function getItemOcrData(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 988)');
            }
        });
    }
}
...
function getItemDescription(item_id) {
    if (item_id) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 989)');
            }
        });
    }
}
