    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="footer_copyright_archive">Copyright &copy; <?php echo date('Y'); ?>. All rights reserved. <a href="index.html" class="link_Archive">ArchiveInABox</a> and box device is a registered trademark of SmallTownPapers, Inc.</p>
            </div>
            <div class="col-md-3">
                <ul>
                    <h3>Links</h3>
...
$jsArray = ['jquery-1.10.2.min.js', 'drag_scroll.js', 'bootstrap.js','jquery-ui.js', 'jquery-form-validate.min.js', 'ideal-image-slider.js', 'iis-bullet-nav.js', 'iis-captions.js', 'common.js', 'sappleslider.multi.js', 'snap.svg-min.js', 'tabulous.js', 'jquery.mCustomScrollbar.concat.min.js', 'jquery.dataTables.min.js', 'index.js', 'jquery.inputmask.bundle.js', 'tag-it.js', 'magicsuggest.js', 'selectize.js'];
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 1064)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1065)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1066)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1067)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 1068)');
                }
                $('.loading-div').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1069)');
            }
        });
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + '. (Error Code: 1070)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1071)');
                }
            });
        }
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1072)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1073)');
                }
            });
        }
    });
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', 'error', 'Something went wrong, Please try again. (Error Code: 1074)');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1075)');
                }
            });
        }
        $(document).on('click', '#agree_term_condition', function () {
            ...
            $.ajax({
                ...
                eroor: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1076)');
                }
            });
        });
