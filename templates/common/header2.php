...
<html xmlns="https://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="bgTopStripe_society">
            <div class="container-fluid">
                <div class="row">
						<div class="col-md-3 col-sm-12 col-xs-12 header_logo text-center">
						<a href="index.html"><img src="<?php echo IMAGE_PATH . 'logo-aib.png'; ?>" alt="" /></a>
						</div>
                    <div class="col-md-9 col-sm-12 col-xs-12 text-right textAlignCenter topMargin10">
                        <ul class="header-menu_society pull-right">
                    ...
                    <li style="display:none;"><a href="javascript:void(0);" class="loginPopup"><span>LOGIN</span> <img src="<?php echo IMAGE_PATH . 'user-icon_society.png'; ?>" class="" alt="" /></a></li>
                                <!--<li class="logout-user"><a href="javascript:void(0);"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> LOGOUT</a></li>-->
                            <?php }else{ ?>
                                <!--<li><a href="search.php"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> SEARCH</a></li> -->
                                
                                <li><a href="javascript:void(0);" class="loginPopup"><span>LOGIN</span> <img src="<?php echo IMAGE_PATH . 'user-icon_society.png'; ?>" class="" alt="" /></a></li>
