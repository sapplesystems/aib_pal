...
<html>
    ...
    <body>
        ...
        <div class="container-fluid containerTop">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12"><a href="index.html"><img class="marginTop8" src="<?php echo IMAGE_PATH . 'logo-aib.png'; ?>" alt="Logo AIB" /></a></div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?php if (isset($_SESSION['aib']['user_data']) && !empty($_SESSION['aib']['user_data'])) { ?>
                    <ul class="logInBtn">
                        <li>
                            <a href="javascript:void(0);">
                                <img class="imgUser" alt="User Image" src="<?php echo IMAGE_PATH . 'avatar.png'; ?>" /> 
