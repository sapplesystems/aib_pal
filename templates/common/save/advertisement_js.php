            ...
            success: function (response) {
                ...
                if (obj.status == 'OK') {
                    ...
                    if (custom_ad_count < 3 && folder_id > 1) {
                        google_ad_script = obj.default_ad_script;
                        is_google_ad_top_left = 1;
                        is_google_ad_top_right = 1;
                        is_google_ad_bottom_left = 1;
                        is_google_ad_bottom_right = 1;
                        $('#top_left_position,#top_left_position_item_detail').html(google_ad_script);
                        $('#top_right_position,#top_right_position_item_detail').html(google_ad_script);
                        $('#bottom_left_position,#bottom_left_position_item_detail').html(google_ad_script);
                        $('#bottom_right_position,#bottom_right_position2,#bottom_right_position_item_detail').html(google_ad_script);
                    }
                    if (google_ad_script != '') {
