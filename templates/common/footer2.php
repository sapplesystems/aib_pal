        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <ul class="footerBottom-none">
                    <h3>Links</h3>
                    <li><a href="terms_condition.html"><span class="glyphicon glyphicon-menu-right"
                                aria-hidden="true"></span> Terms of Use</a></li>
                    <li><a href="privacy_cookies.html"><span class="glyphicon glyphicon-menu-right"
                                aria-hidden="true"></span> Privacy & cookies</a></li>
                    <li><a href="dmca.html"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
                            DMCA</a></li>
                    <li><a href="dmca_counter_notice.html"><span class="glyphicon glyphicon-menu-right"
                                aria-hidden="true"></span> DMCA counter notice</a></li>
                </ul>
            </div>
            <div class="col-md-2">
                <ul>
                    <h3>&nbsp;</h3>
                    <li><a href="javascript:void(0);" class="report-content"><span
                                class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Report Content</a>
                    </li>
                    <li><a href="javascript:void(0);" class="request-removal"><span
                                class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Request Content
                            Removal</a></li>
                    <li><a href="javascript:void(0);" class="front-contact-us"><span
                                class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Contact Us</a></li>
                    <li><a href="javascript:void(0);" class="start-trouble-ticket"><span
                                class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Start Trouble
                            Ticket</a></li>
                </ul>
            </div>
        </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 1125)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1126)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1127)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1128)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1129)');
                }
                $('.loading-div').hide();
            },
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1130)');
            }
        });
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1131)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1132)');
                }
            });
        }
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 1133)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1134)');
                }
            });
        }
    });
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1135)');
                    }
                    $('.admin-loading-image').hide();
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1136)');
                }
            });
        }
        $(document).on('click', '#agree_term_condition', function () {
            ...
            $.ajax({
                ...
                eroor: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 1137)');
                }
            });
        });
