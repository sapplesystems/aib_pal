...
if ($_REQUEST['flg'] != 2) {
    $scrapbook_hide = 'style="display:none;"';// 'hidden=""';
    $reprintPurchaseHide = 'hidden';
}
$ebay_field_hide = "";
if (isset($itemData['properties']['ebay_url']) && !empty($itemData['properties']['ebay_url'])) {
    $image_name = $itemData['properties']['ebay_sale_options'] . '-new.png';
    ...
    $image_name = 'not_applicable-new.png';
    $ebay_url = "#";
    $ebay_field_hide = "hidden";
}
...
$addToScrapbook = '';
if (in_array($_REQUEST['folder_id'], $_SESSION["scrapbook_ref"])) {
...
<style>
#historical_connection_data .customSlider #content-slider-item {height: 165px !important;}
#historical_connection_data .customSlider ul.imageDisplay li.resizeLi {width: 195px !important;border: 5px solid #fdb813;margin-left: 20px !important;}
#historical_connection_data .customSlider .height90 {height: 105px !important;}
#historical_connection_data .padd7 {padding: 0px !important;}
#historical_connection_data .customSlider .ch-info_size {height: 105px !important;width: 100% !important;}
#historical_connection_data .ch-info > div{background-size:cover !important;}
#historical_connection_data .lSAction > .lSPrev{background-image: url(public/images/slider-arrow-left.png) !important; background-size:cover !important;height: 50px !important;width: 50px !important;background-position: center !important; opacity: 1;}
#historical_connection_data .lSAction > .lSNext{background-image: url(public/images/slider-arrow-right.png) !important; background-size:cover !important;height: 50px !important;width: 50px !important;background-position: center !important; opacity: 1;}
#historical_connection_data .ch-info .ch-info-back{background:rgba(0,0,0,0.7) !important; transform: none !important;display: none;}
#historical_connection_data .ch-info .ch-info-back h3{font-size:14px !important;line-height: 20px;font-family: 'NeutraTextBook' !important; position: absolute;top: 50%;transform: translateY(-50%); width: 100%;}
#historical_connection_data .ch-item:hover .ch-info{transform: none !important;}
#historical_connection_data .ch-item:hover .ch-info-back{display:block;padding: 30px 5px 0 5px;}
</style>

<div class="sliderBackground bgGradient_head">
    <div class="container-fluid relativePos">
        <div class="row marginTop20">
            <div class="col-md-2 col-sm-2 col-xs-12">
        <div class="thumbnailLeft_Div">
            <div class="thumb-listing" >
            <a class="thumbnailLeft_arrow_Top leftArrow_details left-arrow-section" href="javascript:void(0);"><span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span></a>
            <a class="thumbnailLeft_arrow_Bottom rightArrow_details right-arrow-section" href="javascript:void(0);"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
                    ...
                    if (count($apiResponse['info']['records']) > 0) {
                        ...
                        foreach ($apiResponse['info']['records'] as $itemDataArray) {
                            ...
                            <div class="sapple-slider-item-thumb" id="sapple-slider-thumb-item-<?php echo $item_count; ?>">
                                ...
                                <img data-url="item-details.html?folder_id=<?php echo $_REQUEST['folder_id']; ?>&itemId=<?php echo $itemDataArray['item_id']; ?>" data-item-type="internal" data-item-id="<?php echo $itemDataArray['item_id']; ?>" data-pr-file-id="<?php echo $itemDataArray['pr_file_id']; ?>" data-tn-file-id="<?php echo $itemDataArray['tn_file_id']; ?>" class="sapple-thumb-list" data-count="<?php echo $item_count; ?>" id="slider-thumb-image-<?php echo $item_count; ?>" src="<?php echo THUMB_URL . '?id=' . $itemDataArray['tn_file_id']; ?>" alt="slider-image" />
                                <?php } else { ?>
                                    ...
                                    <?php }else{ ?>
                                    <img data-url="item-details.html?folder_id=<?php echo $_REQUEST['folder_id']; ?>&itemId=<?php echo $itemDataArray['item_id']; ?>" data-item-type="internal" data-item-id="<?php echo $itemDataArray['item_id']; ?>" data-pr-file-id="<?php echo $itemDataArray['pr_file_id']; ?>" data-tn-file-id="<?php echo $itemDataArray['tn_file_id']; ?>" class="sapple-thumb-list" data-count="<?php echo $item_count; ?>" id="slider-thumb-image-<?php echo $item_count; ?>" src="<?php echo IMAGE_PATH . 'no-image.png'; ?>"/>
                                <?php } } ?>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="imageSldr">
                    <div class="relativePos">
                        <div class="<?php echo $ebay_field_hide; ?>">
                            <a style="display:none" href="<?php echo $ebay_url; ?>" class="ebay_class" target="_blank">
                                <img class="ebay_Icon" src="<?php echo IMAGE_PATH . $image_name; ?>" alt="eBay Icon" />
                            </a>
                        </div>
                        <input type="hidden" name="maximum_image_count" id="maximum_image_count" value="<?php echo count($apiResponse['info']['records']); ?>">
                        <div class="relativePos">
                            <div class="imageSldr sapple-slider-item <?php if(count($apiResponse['info']['records']) <= 0 && $private_records == 'yes'){ echo 'no-item-found'; }elseif(count($apiResponse['info']['records']) <= 0 && $private_records == ''){ echo "no-item"; } ?>" id="sapple-slider-item-0" item-count="0">
                                <div class="relativePos">
                                    <img  class="show_large_image" src="public/images/slider-img.jpg" alt="Slider Image" onload="largeHighLightImage()" />
                                </div>
                            </div>
                            <div class="slideDigit pagination-counter">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="imageDesription">
                    <div class="padding15">
                        <h2>
                            Description
                        </h2>
                        <span class="glyphicon glyphicon-info-sign record_info record_info_custom2" title="Record details" record-id="<?php echo $_REQUEST['folder_id']; ?>" aria-hidden="true"></span>
                        <!--div class="pull-right">
                            <a id="back_to_scrapbook" <?php //echo $scrapbook_hide; ?> href="javascript:void(0);" class="backToBtn">Back to Scrapbook</a>&nbsp;&nbsp;&nbsp;
                            <a id="scrollToComments" href="javascript:void(0);" class="viewToBtn">View Comments</a>
                        </div-->
                    </div>
                    <div id="tabs-11" class="borderBtmNone maxHeight300 marginTop20"></div>
                    <div class="padding15 marginTop20">
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="btnAction">
                                    <li id="add_to_scrapbook" <?php echo $addToScrapbook; ?>><a href="javascript:void(0);" class="reprintBtn">Add to Scrapbook <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></li>
                                    <li class="purchase-reprint" <?php echo $printImagehide.$publicLinkHide; ?>><a class="reprintBtn" href="javascript:void(0);">Purchase Reprint <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></li>
                                    <li id="share_front_items" class="share" <?php echo $shareItemHidden; ?>><a data-item-id-value="<?php echo $itemDataArray['item_id']; ?>" class="reprintBtn" href="javascript:void(0);">Share Link <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></li>
									<li><a id="back_to_scrapbook" <?php echo $scrapbook_hide; ?> href="javascript:void(0);" class="backToBtn">Back to Scrapbook</a></li>
									<li><a id="scrollToComments" href="javascript:void(0);" class="viewToBtn">View Comments</a><li>
                                    <?php if($_SESSION['aib']['user_data']['user_type'] == 'A' && $treeDataArray[1]['item_id']!= $_SESSION['aib']['user_data']['user_top_folder']){ ?>
                                        <li><a href="javascript:void(0);" connecting-item-id="<?php echo $_REQUEST['folder_id']; ?>" class="connect-to-society-detail">Connect to this Record <span class="glyphicon glyphicon-share borderNoneSpan" aria-hidden="true"></span></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="container-fluid marginTop20">
        <div class="row posRelative">
            <div class="col-md-2 col-sm-3 Logocenter">
                <div class="logo_society"><img src="<?php echo ARCHIVE_IMAGE.$archive_logo ; ?>" /></div>
            </div>
            <div class="col-md-1 col-sm-12"></div>
                <div class="arrowSliderBtn">
                    <?php if($preKeyId !=''){ ?>
                        <a class="Previous_Record" href="javascript:pageMoveToItemDetail(<?php echo $preKeyId; ?>)">Previous Record</a>
                    <?php } ?>
                    <?php if($nextKeyId !=''){ ?>
                        <a class="Next_Record" href="javascript:pageMoveToItemDetail(<?php echo $nextKeyId; ?>)">Next Record</a>
                    <?php } ?>
                </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-9">
                <?php if ($is_unclaimed_society && $is_unclaimed_society == '1') { ?>
                    <input type="button" class="btn claim_this_historical_custom pull-right marginBottom10" onclick="openClaimPopup(event);" value="Claim This Historical" />
                <?php } ?>
            </div>
        </div>
    </div>
...
<div class="container marginBottom30">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="sliderMain_heading marginTopNone">Historical <span>Items</span></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <!--div class="sliderMain_Div">
                <div class="sliderMain_Img"><div class="sliderMain_Content"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</span> </div></div>
                <div class="sliderMain_Img"><div class="sliderMain_Content"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</span> </div></div>
                <div class="sliderMain_Img"><div class="sliderMain_Content"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</span> </div></div>
                <div class="sliderMain_Img"><div class="sliderMain_Content"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</span> </div></div>
            </div-->
            <!--div class="slider-arrow-round">
                <a href="javascript:void(0);"><img src="images/slider-arrow-left.png" alt="Slider Image" /></a>
                <a href="javascript:void(0);"><img src="images/slider-arrow-right.png" alt="Slider Image" /></a>
            </div-->
        </div>
    </div>
</div>
...
<div class="relatedContent_div">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10">
                <div id="tabs" class="tab_archive">
                    <ul>
                        <li onclick="setSliderMainHeading('Related','Content');"><a href="#related_content_section">Related<br>Content</a></li>
                        <li onclick="setSliderMainHeading('Public','Connection');"><a href="#public_connection_content_section">Public<br>Connection</a></li>
                        <li onclick="setSliderMainHeading('Comments','');" class="commentsSection"><a href="#tabs-2">Comments</a></li>
                    </ul>
            ...
            <div class="col-md-2"><?php include_once 'ads.php'; ?></div>
        </div>
    </div>
</div> 
<!-- MODAL POPUP CODE STARTS -->
...
//        $('.pagination-counter .total').text(total_item_count);
                ...
                if ($(this).css("display") == "block") {
                    ...
                    var height = $(window).height();
                        $.ajax({
                            ...
                            error: function () {
                                showPopupMessage('error','Something went wrong, Please try again. (Error Code: 930)');
                            }
                        });
        ...
        $(document).on('click','.popup-original-image',function(){
            var item_id = $('.thumb-listing').find('.slider-active-thumb').children('img').attr('data-item-id');
            var pr_file_id = $('.thumb-listing').find('.slider-active-thumb').children('img').attr('data-pr-file-id');
            var url = 'item_id='+item_id+'&pr_file_id='+pr_file_id;
            if(searchString !=''){
    ...
    function getPrimaryImageData(pr_file_id, item_type, data_url, searchString= '', item_id = '') {
        ...
        if(pr_file_id !=''){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 931)');
                }
            }); 
        }else{
    ...
    function getItemCustomFields(item_id,ref_id) {
	    ...
	    $('.loading-div').show();
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('#tabs-11').html(response);
		    $('.loading-div').hide();
                    //$("#tabs ul li:nth-child(1) a").trigger('click');
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 932)');
                }
            });
        }
    }
    ...
    function getItemDetails(item_id) {
        if (item_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 933)');
                }
            });
        }
    }
    ...
    function getItemArchiveProperty(record_id) {
        if (record_id) {
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 934)');
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + '. (Error Code: 935)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 936)');
                }
            });
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (result.status == 'success') {
                    ...
                    showPopupMessage('error', result.message + ' (Error Code: 937)');
                }
            },
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 938)');
            }
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status == 'success') {
                        ...
                        showPopupMessage('error', result.message + ' (Error Code: 939)');
                        setTimeout(function(){
                            $('.loginPopup').trigger('click');
                        },1000);
                    }else{
                        showPopupMessage('error', result.message + ' (Error Code: 940)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Previous request not completed. (Error Code: 941)');
                }
            });
        }
    });
    ...
    function listCommentThreads(parent_folder_id,action) {
        ...
        if (parent_folder_id) { 
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 942)');
                }
            });
        }
    }
    ...
    function deleteCommentFromThread(obj_id){
        if (obj_id) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 943)');
                }
            });
        }
    }
    function addCommentToThread(obj) {
        ...
        if (parent_thread) {            
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 944)');
                }
            });
        }
    }
        ...
        $("#txtUserComments").keyup(function(e){
            ...
            if (e.keyCode == 13 && jQuery.trim(this.value)!="") {                   
                ...
                $.ajax({
                        ...
                        //listCommentThreadsPost(parent_folder_id,"hit");
                         ...
                         if($("#tabs-2 div[id^=comment-]:last").closest(".innerComment").length>0){
                             ...
                             if($("#tabs-2 div[id^=comment-]").length>0){
                               ...
                               $("#tabs-2").prepend(html);
                               $('.headingComment').remove();
                               $('#tabs-2').prepend('<h4 class="headingComment">Comments <button class="btn btn-success pull-right" id="load_comments_details_page">Load Previous Comments</button></h4>');
                             }
                         }
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 945)');
                    }
                });
            }
        });
        ...
        $("#post-your-comments").on("click",function(){
            if (jQuery.trim($("#txtUserComments").val())!="") {                   
                ...
                $.ajax({
                    ...
                    error: function () {
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 946)');
                    }
                });
            }
        });
...
$(document).on('click', '#load_comments_details_page', function(){
    ...
    function getRelatedItems(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 947)');
                }
            });
        }
    } 
	...
	function getPublicConnections(record_id){
        if(record_id){
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error','Something went wrong, Please try again. (Error Code: 948)');
                }
            });
        }
    }
    function get_public_username(email){
         ...
         $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 949)');
            }
        });
    }
...
$('#linkPubConBtn').click(function(){
	...
	$.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 950)');
            }
        });
 ...
 function getScrapbookRecordDetails(record_id){
          $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 951)');
            }
        });
	...
	$(document).on("click" ,".report-user",function(){
        ...
        $(document).on("click","#report_submit",function(){
                       ...
                       $.ajax({
                        ...
                        error: function () {
                            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 952)');
                        }
                });
        });        
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(record.status == 'success'){
                        ...
                        showPopupMessage(response.status, response.message + ' (Error Code: 953)');
                    }
                },
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 954)');
                }
            });
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(record.status == 'success'){
                ...
                showPopupMessage(response.status, response.message + ' (Error Code: 955)');
            }
        },
        error: function () {
            showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 956)');
        }
    });
});
...
function getSavedScrapbookTitle(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 957)');
            }
        });
    }
}
...
function getItemOcrData(item_id){
    if(item_id){
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Previous request not completed. (Error Code: 958)');
            }
        });
    }
}
...
$(document).on('click','#scrollToComments', function(){
    $('.commentsSection a').trigger('click');
    $('html,body').animate({
        scrollTop: $('.tab_archive').offset().top
    }, 1000);
});
...
function getItemDescription(item_id) {
    if (item_id) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 959)');
            }
        });
    }
}
