<style>
    ...
    #advertisement5.ad_border{width: 300px;display: inline-block;overflow: hidden;/*position: absolute;top: 20px;right: 0px;left: 25px;*/height:250px;/*margin-top: 20px;*/}
    #advertisement5.ad_border img{width:300px;height:250px;} 
</style> 
<?php
if ($response['status'] == 'OK') {
    ...
    if ($ad_record_count) {
        ?>
        <div class="ad_border" id="advertisement5">
            ...
            <?php } else { ?>
                ...
                <?php /*if ($ad_display_flip_time > 0) { ?>
                    <script type="text/javascript">
                        setTimeout(function () {
                            getAdvertisementFlip5(<?php echo json_encode($response); ?>, '<?php echo $_REQUEST['folder_id']; ?>',<?php echo $a++; ?>);
