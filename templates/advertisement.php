...
marquee{height: 555px;}
    ...
    .ad_border{border:1px solid #cccccc;width: 100%;display: inline-block;overflow: hidden;300px}
</style>
<?php
if ($response['status'] == 'OK') {
    ...
    $ad_display_flip_time = ($apiResponse['info']['records']['ad_display_flip_time']) ? $apiResponse['info']['records']['ad_display_flip_time'] : '5';
            ...
            <?php } else { ?>
                ...
                ?>
                    <script type="text/javascript">
                        setTimeout(function(){
                            getAdvertisementFlip(<?php echo json_encode($response); ?>,'<?php echo $_REQUEST['folder_id']; ?>',<?php echo $a++; ?>);
