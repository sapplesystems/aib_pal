            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" name="contact_aib_form" id="contact_aib_form" method="POST" action="">
                    <input type="hidden" name="request_type" id="request_type" value="CT">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-4 control-label">Please verify that you're not<br />a robot :</label>
                            <div class="col-sm-7">
                                <div class="g-recaptcha" id="g-recaptcha-contact" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;" data-sitekey="6LcH8jIUAAAAAIA10p98ERf6xXnvD2RN-5QmXrVL"></div>
                                <label style="display:none" id="g-recaptcha-response-error" class="error" for="g-recaptcha-response"></label>
                                <label class="custom-captcha_error" style="display:none;">Please validate the captcha</label>
                            </div>
                        </div>
...
<script type="text/javascript">
    var CaptchaCallback  = function() {
        grecaptcha.render('g-recaptcha-contact', {
          sitekey : '6LcH8jIUAAAAAIA10p98ERf6xXnvD2RN-5QmXrVL',
          theme : 'light'
        });
    };
