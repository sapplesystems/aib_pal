...
// AIB config
//
if (defined("AIB_MAIN_INCLUDE") == false)
{
	define('AIB_MAIN_INCLUDE',true);
include("/home/stparch/virtual_sites/www.archiveinabox.com/config/aib_site.php");

define('AIB_SESSION_TIMEOUT','28800');
...
define("RC_SITE_KEY", "6LcQRaYUAAAAAKUQLHyaxyJqN6YdtZQzi4FET4cB");
define("RC_SECRET_KEY", "6LcQRaYUAAAAAEqW4X68KbMb7jq_NkOJ535NZWuR");
