...
<script type="text/javascript">
    ...
    function getItemDetailsById(folder_id) {
        ...
        $.ajax({
            ...
            error: function () {
                $('.admin-loading-image').hide();
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 290)');
            }
        });
    }
        ...
        if(ref_item_id){
            if(confirm('Are you sure you want to delete this? This cannot be undone')){
                ...
                $.ajax({
                    ...
                    error: function () {
                        $('.admin-loading-image').hide();
                        showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 291)');
                    }
                });
            }
        }
