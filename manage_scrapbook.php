...
<script type="text/javascript">
    ...
    function getScrapbookListing() {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 234)');
            }
        });
    }
    ...
    $(document).on('click', '.edit_scrapbook', function(){
        ...
        if(scrapbook_id){
			...
			$.ajax({
                                ...
                                error: function () {
                                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 235)');
                                }
                        });
	...
	$(document).on('click', '#edit_scrapbook_button', function(){
            if ($("#edit_scrapbook_form").valid()) {
			 ...
			 $('#manage_edit_scrapbook').modal('hide');
                    ...
                    error: function () {
                        showPopupMessage('error','Something went wrong, Please try again. (Error Code: 236)');
                    }
                });
            }
    });
    ...
    $(document).on('click', '.delete_scrapbook', function () {
        ...
        if (confirm("Are you sure to delete the scrapbook? This cannot be undone")) {
            ...
            $.ajax({
                ...
                error: function () {
                    $('.admin-loading-image').hide();
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 237)');
                }
            });
        }
    });
...
//        });
    ...
    $(document).on("click", "#save_form_data", function () {
        if ($("#share_scrapbook").valid()) {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 238)');
                }
            });
        }
    });
    ...
    function selectPublicUser(email) {
        ...
        $.ajax({
            ...
            error: function () {
                showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 239)');
            }
        });
    }
</script>