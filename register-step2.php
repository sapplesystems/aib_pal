...
<script type="text/javascript">
                        ...
                        function get_state() {
                            ...
                            $.ajax({
                                ...
                                error: function () {
                                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 270)');
                                    $('.loading-div').hide();
                                }
                            });
                        }
    ...
    function getItemPropDetails(archive_id, user_id) {
        if (archive_id != '') {
            ...
            $.ajax({
                ...
                error: function () {
                    showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 271)');
                }
            });
        }
    }
