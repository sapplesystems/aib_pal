...
<?php } ?>
				...
				error: function () {
					$('.admin-loading-image').hide();
					showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 244)');
				}
			});
	}
	}
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (result.status == 'success') {
						...
						showPopupMessage('error', 'Something went wrong! Please try again. (Error Code: 245)');
						return false;
					}
				},
				error: function () {
					showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 246)');
				}
			});
		}
	});
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (result.status == 'success') {
						...
						showPopupMessage('error', 'Something went wrong! Please try again. (Error Code: 247)');
						return false;
					}
				},
				error: function () {
					showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 248)');
				}
			});
		}
	});
...
<?php } ?>
			...
			error: function () {
				$('.admin-loading-image').hide();
				showPopupMessage('error', 'Something went wrong, Please try again. (Error Code: 249)');
			}
		});
