    ...
    $(document).ready(function () {
        ...
        if(usertype == 'U'){
			$.ajax({
				...
				error: function () {
					showPopupMessage('error','Something went wrong, Please try again. (Error Code: 113)');
				}
			});
			/*
            $.ajax({
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result.status == 'success') { 
                            ...
                            showPopupMessage('error', result.message + ' (Error Code: 1163)');
                        }
                    },
                    error: function () {
                        showPopupMessage('error','Something went wrong, Please try again. (Error Code: 114)');
                    }
                });
            }
        });
