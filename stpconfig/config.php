...
//define("DBUSER",'aibstp');                        //Database User
//define("DBPASS",'uongooC9bePo');                                //Database Password
//define("DBHOST",'235.216.107.1');                //Database Host122.160.68.237
//define("DATABASE",'stparchive');
define("DBUSER",'stparch');                        //Database User
define("DBPASS",'stpuser');                                //Database Password
